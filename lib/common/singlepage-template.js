    ...
    try {
...

        {
            ...
            var tags = await page.evaluate(function process() {
                ...
                // try { tags.push("<span class='issue-date' title='issue-date'></span>"); } catch (e) { }
                // try { tags.push("<span class='effective-date' title='effective-date'></span>"); } catch (e) { }
                ...
                // TODO:
                // try { tags.push("<span class='h2' title='level2'></span>", "<br>"); } catch (e) { }
                // try { tags.push("<span></span>", "<br>"); } catch (e) { }

                // try { tags.push("<span class='h3' title='level3'></span>", "<br>"); } catch (e) { }
                // try { tags.push("<span></span>", "<br>"); } catch (e) { }

                // try { tags.push("<span class='h4' title='level4'></span>", "<br>"); } catch (e) { }
                // try { tags.push("<span></span>", "<br>"); } catch (e) { }

                // try { tags.push("<span class='h5' title='level5'></span>", "<br>"); } catch (e) { }
                // try { tags.push("<span></span>", "<br>"); } catch (e) { }
