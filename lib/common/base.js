...
async function createFolder(url, sp, path) {
    const id = sha1(url);
    const outputPath = path + path.sep + sp;
    const originalHtmlPath = outputPath + path.sep + id + "_original.html";
    const buildHtmlPath = outputPath + path.sep + id + ".html";
    const originalTextPath = outputPath + path.sep + id + "_original.txt";
    const buildTextPath = outputPath + path.sep + id + ".txt";
    const metadataPath = outputPath + path.sep + id + "_metadata.json";
