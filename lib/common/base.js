...
async function originalToText(browser, originalHtmlPath, originalTextPath, originalRootScope, originalRemoveSelectors) {
    {
...
async function buildToText(browser, buildHtmlPath, buildTextPath, buildRootScope, buildRemoveSelectors) {
    {
        const page = await browser.newPage();
...
async function runTest(browser, originalHtmlPath, originalTextPath, buildHtmlPath, buildTextPath, originalRootScope, originalRemoveSelectors, buildRootScope, buildRemoveSelectors) {
    await originalToText(browser, originalHtmlPath, originalTextPath, originalRootScope, originalRemoveSelectors);
    await buildToText(browser, buildHtmlPath, buildTextPath, buildRootScope, buildRemoveSelectors);
}
