...
async function reLocatePage(page, url, sp, path, keepLevel1InEaseContent) {
...
async function writePage(page, url, sp, path, executeWriteAnnotatedPage, executeCleanupPage, keepLevel1InEaseContent) {
    ...
    await reLocatePage(page, url, sp, path, keepLevel1InEaseContent);
