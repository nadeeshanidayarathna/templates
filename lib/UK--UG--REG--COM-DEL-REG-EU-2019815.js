    ...
    try {
...

        {
            ...
            var tags = await page.evaluate(function process(url) {
                ...
                try { tags.push("<div class='level1' title='level1'>" + elements[18].outerHTML + "</div>"); } catch (e) { }
                        ...
                        for(const childs of elementsContent.children){
                            ...
                            for(const child of childs.children){
                                ...
                                for(const chlidNesteds1 of child.children){
                                    if(chlidNesteds1.localName == "header"){
        ...
        await test.runTest(browser, originalHtmlPath, originalTextPath, buildHtmlPath, buildTextPath, ".handbook-content", [], "body", [".level1>li"]);
        await browser.close();
    } catch (e) {
        console.log(e);
