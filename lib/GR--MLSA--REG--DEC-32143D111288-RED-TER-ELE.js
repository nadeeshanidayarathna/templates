    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                wrapElementDate(document, effectiveDateElement, "effective-date", "2018-06-22T00:00:00");
                ...
                const contentL3 = document.querySelectorAll(".MsoNormal")[10];
                wrapElement(document, contentL3, "level3");

                const contentL4 = document.querySelectorAll("h6");
                wrapElements(document, contentL4, "level4", group = false);

                const contentL5 = document.querySelectorAll("h7");
