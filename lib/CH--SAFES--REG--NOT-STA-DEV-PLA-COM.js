    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                wrapElementDate(document, "issue-date", "2002-07-08" + "T00:00:00");
                ...
                const level2Elements = document.querySelectorAll('p')[6];
                ...
                Array.prototype.forEach.call(document.querySelectorAll(".detail_gn, .list_mtit, li"), function (node) { node.remove(); });
