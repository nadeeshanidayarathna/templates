...
const scraper = async function download(url, sp, path) {
    try {
        ...
        const { downloadPath, buildPath } = await common.createFolder(url, sp, path);
        ...
        await common.download(downloadPath, page, url);
        ...
        // 3.Collect
        {
            ...
            var tags = await page.evaluate(function process() {
                ...
                try { tags.push("<span class='h0' title='level0'>" + elements[0].innerHTML + "</span>", "<br>"); } catch (e) { }
                ...
                // content between root and main iteration
                {
                    ...
                    try { tags.push("<span class='h1' title='level1'>" + pTransforms[0].innerHTML + "</span>", "<br>"); } catch (e) { }
                ...
                // content main iteration
                {
                    ...
                    for (const element of elements) {
                        ...
                        try { tags.push("<span class='h1' title='level1'>" + h2.innerHTML + "</span>", "<br>"); } catch (e) { }
                            ...
                            if (innerElement.tagName == "P") {
                                ...
                                if (innerElement.firstChild.tagName == "STRONG") {
                                    ...
                                    if (result == null) {
                                        ...
                                        try { tags.push("<span class='h2' title='level2'>" + headingText + "</span>", "<span>" + paraText + "</span>", "<br>"); } catch (e) { }
                                    }
                                } else {
                                ...
                                for (const listElement of listElements) {
                                    index++;
                                    try { tags.push("<span class='h2' title='level2'>" + index + ".</span>", "<span>" + listElement.innerHTML + "</span>", "<br>"); } catch (e) { }
                                }
                            } else {
            ...
            // 4.Build
            await common.build(buildPath, tags);
        }
        await page.close();
        await browser.close();
    } catch (e) {
