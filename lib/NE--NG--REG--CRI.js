            ...
            var tags = await page.evaluate(function process(url) {
                ...
                try { tags.push("<div class='content'>"); } catch (e) { }
                {
                    ...
                    for (boekElement of boekElements) {
                        ...
                        try { tags.push("<div class='level2' title='level2'>" + headingBoek.outerHTML + "</div>"); headingBoek.remove(); } catch (e) { }
                        ...
                        for (titleElement of titleElements) {
                            ...
                            try { tags.push("<div class='level3' title='level3'>" + title.outerHTML + "</div>"); title.remove(); } catch (e) { }
