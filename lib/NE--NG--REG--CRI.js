            ...
            var tags = await page.evaluate(function process() {
                ...
                try { tags.push("<span class='content'>"); } catch (e) { }
                {
                    ...
                    for (boekElement of boekElements) {
                        ...
                        try { tags.push("<span class='level2' title='level2'>" + headingBoek.innerHTML + "</span>", "<br>"); headingBoek.remove(); } catch (e) { }
                        ...
                        for (titleElement of titleElements) {
                            ...
                            try { tags.push("<span class='level3' title='level3'>" + title.innerHTML + "</span>", "<br>"); title.remove(); } catch (e) { }
