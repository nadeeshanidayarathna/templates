                ...
                for (const sectionChild of sectionChilds) {
                    ...
                    if (sectionChild.tagName == "H2") {
                        ...
                        if (h2MultiTags == false && nextTagName == "H3") {
                            ...
                            try { tags.push("<span class='h2' title='level2'>" + sectionChild.innerHTML); } catch (e) { }
                        } else {
                            if (sectionChild.childNodes.length == 2) {
                                try { tags.push("<span class='h2' title='level2'>" + sectionChild.childNodes[0].innerHTML + " " + sectionChild.childNodes[1].innerHTML + "</span>", "<br>"); } catch (e) { }
                        ...
                        for (const scheduleChild of scheduleChilds) {
                            if (scheduleChild.tagName == "HEADER" && scheduleChildHeaderCount == 0) {
                                ...
                                try { tags.push("<span class='h2' title='level2'>" + scheduleChildHeader.innerHTML + "</span>", "<br>"); } catch (e) { }
                                try { tags.push("<span>TODO</span>", "<br>"); } catch (e) { }
                ...
                for (const contentSection2 of contentSection2s) {
                    ...
                    for (const contentSection2Child of contentSection2Childs) {
                        if (contentSection2Child.tagName == "H2") {
                            try { tags.push("<span class='h2' title='level2'>" + contentSection2Child.innerHTML + "</span>", "<br>"); } catch (e) { }
                            try { tags.push("<span>TODO</span>", "<br>"); } catch (e) { }
                        }
                    }
                }
