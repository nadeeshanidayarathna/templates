    ...
    try {
...

        {
            ...
            var tags = await page.evaluate(function process() {
                ...
                try { tags.push("<div class='level1' title='level1'>" + rootTitle.innerHTML + "</div>"); } catch (e) { }
                ...
                try { tags.push("<div>" + headingSection.innerHTML + "</div>"); } catch (e) { }
                ...
                for (const sectionChild of sectionChilds) {
                    ...
                    if (sectionChild.tagName == "H2") {
                        ...
                        if (h2MultiTags == false && nextTagName == "H3") {
                            ...
                            try { tags.push("<div class='level2' title='level2'>" + sectionChild.innerHTML); } catch (e) { }
                        } else {
                            if (sectionChild.childNodes.length == 2) {
                                try { tags.push("<div class='level2' title='level2'>" + sectionChild.childNodes[0].innerHTML + " " + sectionChild.childNodes[1].innerHTML + "</div>"); } catch (e) { }
                            } else {
                                try { tags.push("<div class='level2' title='level2'>" + sectionChild.innerHTML + "</div>"); } catch (e) { }
                            }

                        }
                    } else if (h2MultiTags == false && previousTagName == "H2" && sectionChild.tagName == "H3") {
                        // finishing multi heading level2
                        try { tags.push(" " + sectionChild.innerHTML + "</div>"); } catch (e) { }
                        ...
                        for (const scheduleChild of scheduleChilds) {
                            if (scheduleChild.tagName == "HEADER") {
                                    ...
                                    if (headerChild.tagName == "H2") {
                                        ...
                                        for (const h2Child of h2Childs) {
                                            if (Array.from(h2Child.classList).includes("scheduleLabel")) {
                                                ...
                                                try { tags.push("<div class='level3' title='level3'>" + h2Child.innerHTML + "</div>"); } catch (e) { }
                                            } else {
                                ...
                                try { tags.push("<div class='level2' title='level2'>" + scheduleChild.innerHTML + "</div>"); } catch (e) { }
                                ...
                                if (footNoteElements.length == 1) {
                                    try { tags.push("<div class='level3' title='footnote'>" + footNoteElements[0].innerHTML + "</div>"); } catch (e) { }
                                }
                            } else {
                        ...
                        try { tags.push("<div class='level3' title='level3'>" + sectionChild.innerHTML + "</div>"); } catch (e) { }
                    } else if (sectionChild.tagName == "H4") {
                        try { tags.push("<div class='level4' title='level4'>" + sectionChild.innerHTML + "</div>"); } catch (e) { }
                    } else {
                ...
                for (const contentSection2 of contentSection2s) {
                    ...
                    for (const contentSection2Child of contentSection2Childs) {
                        if (contentSection2Child.tagName == "H2") {
                            try { tags.push("<div class='level2' title='level2'>" + contentSection2Child.innerHTML + "</div>"); } catch (e) { }
                        } else {
