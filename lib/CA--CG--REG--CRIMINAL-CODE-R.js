        ...
        // 3.Collect
        {
            ...
            var tags = await page.evaluate(function process() {
                ...
                for (const sectionChild of sectionChilds) {
                    ...
                    if (sectionChild.tagName == "H2") {
                        ...
                        for (const scheduleChild of scheduleChilds) {
                            if (scheduleChild.tagName == "HEADER" && scheduleChildHeaderCount == 0) {
                                const scheduleChildHeader = scheduleChild.querySelectorAll("h2 > .scheduleLabel")[0];
                                try { tags.push("<span class='level2' title='level2'>" + scheduleChildHeader.innerHTML + "</span>", "<br>"); } catch (e) { }
                                try { tags.push("<span>TODO</span>", "<br>"); } catch (e) { }
                    ...
                    } else if ((previousTagName == "H2" && sectionChild.tagName == "P") || (previousPreviousTagName == "H2" && previousTagName == "H3" && sectionChild.tagName == "P") || (sectionChild.tagName == "H3")) {
