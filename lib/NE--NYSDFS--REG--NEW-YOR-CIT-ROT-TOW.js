    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                // # root:info #
                // #############
                const rootTitle = "New York City Rotation Towing Program to recover stolen or abandoned vehicles and insurer’s right to take insured vehicles into custody for safekeeping prior to the payment of a loss.";
                ...
                const level2Element = document.querySelector('#vtyl2');
