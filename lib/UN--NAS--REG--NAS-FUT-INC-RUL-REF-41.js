    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                // # root:info #
                // #############
                const rootTitle = "Nasdaq Futures, Inc. Rulebook - Reference Guides & Alerts - Futures Trader Alerts #2017-11";
                ...
                Array.prototype.forEach.call(document.querySelectorAll("th, .footnote2, hr"), function (node) { node.remove(); });
