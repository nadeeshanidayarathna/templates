...

        {
            ...
            var tags = await page.evaluate(function process(url) {
                ...
                try { tags.push("<div class='content'>"); } catch (e) { }
                {
                    ...
                    try { tags.push("<div class='level2' title='level2'>" + subHeading.outerHTML + "</div>"); subHeading.remove(); } catch (e) { }
                    ...
                    for (titleElement of titleElements) {
                        ...
                        try { tags.push("<div class='level3' title='level3'>" + titleHeading.outerHTML + "</div>"); titleHeading.remove(); } catch (e) { }
                        ...
                        if (afdelingElements.length > 0) {
                            for (afdelingElement of afdelingElements) {
                                ...
                                try { tags.push("<div class='level4' title='level4'>" + headingAfdeling.outerHTML + "</div>"); headingAfdeling.remove(); } catch (e) { }
