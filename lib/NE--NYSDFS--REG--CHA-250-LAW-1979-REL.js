    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                // # root:info #
                // #############
                const rootTitle = "Chapter 250 of the Laws of 1979, in relation to failure to file annual statements or to reply to inquiries and relating to penalties in connection therewith.";
                ...
                const level2Element = document.querySelector('p#vtyl2');
