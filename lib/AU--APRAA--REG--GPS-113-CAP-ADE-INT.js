    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                // # root:info #
                // #############
                const rootTitle = "GPS 113 Capital Adequacy Internal Model-based Method";
                ...
                Array.prototype.forEach.call(document.querySelectorAll("h5>img"), function (node) { node.remove(); });
