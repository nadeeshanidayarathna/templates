    ...
    try {
...

        {
            ...
            var tags = await page.evaluate(function process(url) {
                ...
                Array.prototype.forEach.call(document.querySelectorAll(".wb-invisible, .mfp-hide"), function (node) { node.remove(); });
        ...
        await test.runTest(browser, originalHtmlPath, originalTextPath, buildHtmlPath, buildTextPath, "main", [".legisHeader",".FCSelector","#right-panel",".wb-invisible","dt div.DefinedTerm",".mfp-hide","#wb-dtmd"], "body", []);
        await browser.close();
    } catch (e) {
        console.log(e);
