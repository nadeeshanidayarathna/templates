...
const scraper = async function download(url, sp, path) {
    try {
        ...
        await test.runTest(browser, originalHtmlPath, originalTextPath, buildHtmlPath, buildTextPath, "main", [".legisHeader", ".FCSelector", "#right-panel", ".wb-invisible", "dt .DefinedTerm", ".mfp-hide", "#wb-dtmd", ".PITLink"], "body", []);
        await browser.close();
    } catch (e) {
        console.log(e);
