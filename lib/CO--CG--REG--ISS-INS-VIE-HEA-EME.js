    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                const footLevel = document.querySelectorAll(".c152")[0];
                wrapElement(document, footLevel, "level4");

                const contentsL5 = document.querySelectorAll("h6");
                for(const contentL5 of contentsL5){
                    wrapElement(document, contentL5, "level5");
                }

                // removing unwanted content from ease-content
                Array.prototype.forEach.call(document.querySelectorAll(".c45"), function (node) { node.remove(); });
