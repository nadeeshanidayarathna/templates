                    ...
                    if(elementContent.tagName == "P"){
                        ...
                        if(elementContent.innerText.includes("SECCION")){                            
                            ...
                            for(const child of elementContent.childNodes){
                                ...
                                } else if(child.tagName == "P" && (child.style.cssText == "text-align: justify;" || child.style.cssText == "") && child.firstChild.nodeName != "STRONG" && (child.textContent.startsWith("ARTÍCULO") || child.firstChild.localName == "b" || child.textContent.includes("ARTÍCULO 323") || child.textContent.includes("Artículo 149") || child.textContent.startsWith("Transitorio"))){
