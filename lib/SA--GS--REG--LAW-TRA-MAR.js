...
const scraper = async function download(url, sp, path) {
    try {
        ...
        await test.runTest(browser, originalHtmlPath, originalTextPath, buildHtmlPath, buildTextPath, ".app_inner_pages_container", ["footer","script", ".system_terms_tools",".fmenu", ".bottom_bar", "#divReportIssueContainer", "#divAddReportIssueSuccess", "#divPrevVersionsContainer", "#divAAddVisitorFavoriteSuccess", ".browse_count"], "body", [".browse_count"]);
        await browser.close();
    } catch (e) {
        console.log(e);
