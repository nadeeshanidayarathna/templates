    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                wrapElementDate(document, "issue-date", "1998-05-13" + "T00:00:00");
                ...
                for (const level2Element of level2Elements) {
                    if (level2Element.textContent.startsWith('附件：')) {
                        const level2text = level2Element.textContent.slice(0,3);
