...
const scraper = async function download(url, sp, path) {
    try {
        ...
        await test.runTest(browser, originalHtmlPath, originalTextPath, buildHtmlPath, buildTextPath, ".region-laurier-first", [".list-unstyled.mrgn-lft-md"], "body", [".created-index"]);
        await browser.close();
    } catch (e) {
        console.log(e);
