    ...
    try {
        ...
        // 3.Collect
        {
            ...
            var { tags, data } = await page.evaluate(function process() {
                ...
                data.push({ "level": "level1", "tag": elements[0].tagName, "x": elements[0].offsetLeft, "y": elements[0].offsetTop, "html": elements[0].textContent });
                ...
                data.push({ "level": "issue-date", "tag": issueDates[0].tagName, "x": issueDates[0].offsetLeft, "y": issueDates[0].offsetTop, "html": issueDates[0].textContent });
                ...
                // content between root and main iteration
                {
                    ...
                    data.push({ "level": "level2", "tag": pTransforms[0].tagName, "x": pTransforms[0].offsetLeft, "y": pTransforms[0].offsetTop, "html": pTransforms[0].textContent });
                }
                ...
                // content main iteration
                {
                    ...
                    for (const element of elements) {
                        ...
                        data.push({ "level": "level2", "tag": h2.tagName, "x": h2.offsetLeft, "y": h2.offsetTop, "html": h2.textContent });
                            ...
                            if (innerElement.tagName == "P") {
                                ...
                                if (innerElement.firstChild.tagName == "STRONG") {
                                    ...
                                    if (result != null) {
                                        ...
                                        data.push({ "level": "level3", "tag": innerElement.tagName, "x": innerElement.offsetLeft, "y": innerElement.offsetTop, "html": headingText });
                                    }
                                }
                                ...
                                for (const listElement of listElements) {
                                    ...
                                    data.push({ "level": "level3", "tag": listElement.tagName, "x": listElement.offsetLeft, "y": listElement.offsetTop, "html": listElement.textContent });
                                }
                            }
                        }
                    }
            ...
            await page.evaluate(function process(data) {
...

                {
                    for (const tagData of data) {
                        ...
                        for (const element of elements) {
                            if (element.tagName == tagData.tag && element.textContent == tagData.html) {
