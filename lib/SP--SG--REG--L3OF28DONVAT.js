...
const scraper = async function download(url, sp, path) {
    try {
        ...
        await test.runTest(browser, originalHtmlPath, originalTextPath, buildHtmlPath, buildTextPath, "#textoxslt > div.bloque , .metadatos,div.redaccion > label > span ,.dropdown > label > span,.enlaces-conso, h3", [".subtitMostrado", "FORM", "p.bloque"], "body", []);
        await browser.close();
    } catch (e) {
        console.log(e);
