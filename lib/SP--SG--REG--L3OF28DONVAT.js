    ...
    try {
...

        {
            ...
            var tags = await page.evaluate(function process(url) {
                ...
                const rootTransformHeadings = document.querySelectorAll("#textoxslt > h3");
                AddTransforms(rootTransformHeadings);
                {
                    ...
                    for (const element of elements) {
                        ...
                        for (const child of childs) {
                            ...
                            } else if(child.className != "titulo_tit" && child.className != "capitulo_tit"){
                                AddTransform(child);
                            }
                        }
                    }
        ...
        await test.runTest(browser, originalHtmlPath, originalTextPath, buildHtmlPath, buildTextPath, "#textoxslt > div.bloque , h3", ["script",".subtitMostrado","FORM","p.bloque"], "body", []);
        await browser.close();
    } catch (e) {
        console.log(e);
