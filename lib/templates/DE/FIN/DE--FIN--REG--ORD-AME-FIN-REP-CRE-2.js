    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                wrapElementDate(document, "issue-date", "2020-11-09" + "T00:00:00");
                ...
                const level2Element = document.querySelectorAll('.CentreretParagraf');
                wrapElements(document, level2Element, "level2");

                const level3Element = document.querySelectorAll('.AendringNr');
