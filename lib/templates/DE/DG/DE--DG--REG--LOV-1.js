    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                Array.prototype.forEach.call(document.querySelectorAll(".col-5, .row > .col-md-6 > .my-2, .row > .col-md-6 > .py-2, .py-2, .paragraph-search-tab, .btn-primary"), function (node) { node.remove(); });
