    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                // # root:info #
                // #############
                const level1Element = document.querySelectorAll("p")[0];
                ...
                const level2Element = document.querySelectorAll("i p");
                wrapElements(document, level2Element, "level2");

                const level3Element = document.querySelectorAll("b");
                wrapElements(document, level3Element, "level3");

                const footnoteElement = document.querySelectorAll("#NOTER");
                wrapElements(document, footnoteElement, "footnote");

                const ahreftag = document.querySelectorAll("p a")[0];
