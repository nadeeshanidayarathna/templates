            ...
            await page.evaluate(function process() {
                ...
                for(const element of elements){
                    if(element.className == "Kapitel"){
                        ...
                        if((!element.outerText.includes("§ 47. Loven træder i kraft den 1. september 2020, jf. dog stk. 2." ))){
                            if(!element.outerText.includes("§ 48. Ferie optjent i perioden fra den 1. januar 2019 til den 31. august 2019,")){
                ...
                Array.prototype.forEach.call(document.querySelectorAll(".col-5, .row > .col-md-6 > .my-2, .row > .col-md-6 > .py-2, .py-2, .paragraph-search-tab, .flex-grow-1"), function (node) { node.remove(); });
