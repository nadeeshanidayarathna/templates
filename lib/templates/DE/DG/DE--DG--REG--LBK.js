...
const scraper = async function download(url, sp, path) {
    try {
        ...
        });
        {
            ...
            // 2.Identify
            // 3.Wrap
            await page.waitForSelector(".document-details-content.col-md-8");
            await page.evaluate(function process() {
                ...
                // # content:info #
                // ################
                const contentElement = document.querySelector('.document-details-content.col-md-8');
                ...
                Array.prototype.forEach.call(document.querySelectorAll(".col-5, .row > .col-md-6 > .my-2, .row > .col-md-6 > .py-2"), function (node) { node.remove(); });
