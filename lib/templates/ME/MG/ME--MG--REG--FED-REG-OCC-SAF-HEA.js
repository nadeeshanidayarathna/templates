    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                wrapElementDate(document, "issue-date", "2014-11-13" + "T00:00:00");
            ...
            //        if (level5Element.textContent.match(/^Artículo\s\d+\./)) {
            //            const level5text = /^Artículo\s\d+\./.exec(level5Element.textContent);
            ...
            //        if (level3Element.textContent.match(/^Artículo\s\d+\./)) {
            //        // console.log("level 5 awa" + level3Element.textContent)
            //            const level3text = /^Artículo\s\d+\./.exec(level3Element.textContent);
