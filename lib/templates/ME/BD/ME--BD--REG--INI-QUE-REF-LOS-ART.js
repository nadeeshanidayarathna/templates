    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                // # root:info #
                // #############
                const level1Element = document.querySelector('.c74');
                wrapElement(document, level1Element, "level1");
                wrapElementDate(document, "issue-date", "2022-05-11" + "T00:00:00");
                ...
                const footnoteElement = document.querySelectorAll('.fnote');
