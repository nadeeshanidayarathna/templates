    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                wrapElementDate(document, "issue-date", "2022-06-28" + "T00:00:00");
                wrapElementDate(document, "effective-date", "2022-06-28" + "T00:00:00");
                // ################
                // # content:info #
                // ################
                ...
                const level2Elements = document.querySelectorAll(".MsoBodyText ");
                const regex = /^(Sec\.\s\d\.)(.*)/i;
