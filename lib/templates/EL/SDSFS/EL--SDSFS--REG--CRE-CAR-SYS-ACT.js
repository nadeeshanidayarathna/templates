    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                wrapElementDate(document, "issue-date", "2022-01-12" + "T00:00:00");
                wrapElementDate(document, "effective-date", "2022-01-12" + "T00:00:00");
                ...
                for (const elements of level2Element) {
                    if (elements.textContent.trim().match(/FINAL$/)) {
                        wrapElement(document, elements, "level2");
                    } else if (elements.textContent.trim().match(/^CAPÍTULO/)) {
                ...
                const level4Element = document.querySelectorAll('p > b');
                for (const elements of level4Element) {
                    if (elements.textContent.trim().match(/^Art/)) {
