    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                // # root:info #
                // #############
                wrapElementLevel1(document, "November 2009 - Updated Operational Guidance applicable to Captive Insurance Undertakings");
                wrapElementDate(document, "issue-date", "2009-11-01" + "T00:00:00");
                ...
                const level4Element = document.querySelector('h3');
