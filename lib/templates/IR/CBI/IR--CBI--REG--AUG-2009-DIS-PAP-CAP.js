    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                // # root:info #
                // #############
                const rootTitle = "August 2009 - Discussion Paper on Capital Requirements for Variable Annuities Business";
                wrapElementLevel1(document, rootTitle);

                wrapElementDate(document, "issue-date", "2009-08-01" + "T00:00:00");
