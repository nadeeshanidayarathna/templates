    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                wrapElementDate(document, "issue-date", "2016-06-30" + "T00:00:00");
                ...
                const level2Elements = document.querySelectorAll('.ti-section-1');
                ...
                const level3Element = document.querySelectorAll('.ti-art');
                for (const element of level3Element) {
                    if (element.nextElementSibling.className == 'sti-art') {
                        ...
                        wrapElements(document, level3Elements, "level3", group=true);
                    } else {
