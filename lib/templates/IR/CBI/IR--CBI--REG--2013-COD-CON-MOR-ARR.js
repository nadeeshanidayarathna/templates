    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                wrapElementDate(document, "issue-date", "2013-07-01" + "T00:00:00");
                ...
                for(const child of level2Element){
                    if(child.textContent.match(/^CHAPTER/) || child.textContent.match(/^APPENDIX/)){
                        let arrList = [];
                        arrList.push(child);
                ...
                const level3Element = document.querySelectorAll('.cc3');
                wrapElements(document, level3Element, "level3");

                const level4Element = document.querySelectorAll('.cc4');
                wrapElements(document, level4Element, "level4");

                const level5Element = document.querySelectorAll('.cc5');
                wrapElements(document, level5Element, "level5");

                const footnoteElement = document.querySelectorAll('.ccf');
