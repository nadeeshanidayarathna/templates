    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                // # root:info #
                // #############
                const level1Text = "2011 Code of Conduct on Mortgage Arrears";
                wrapElementLevel1(document, level1Text);
                wrapElementDate(document, "issue-date", "2010-02-19" + "T00:00:00");
                // ################
                // # content:info #
                // ################
                ...
                const level5Elements = document.querySelectorAll("h3");
