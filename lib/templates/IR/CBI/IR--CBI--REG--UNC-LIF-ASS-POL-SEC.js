    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                // const dateElements = document.querySelector(".t1 td:nth-child(3)").textContent.trim().replace("    ,","");
                ...
                const issueDate = document.querySelectorAll(".t1 td:nth-child(2)")[1];
                const dateElements = issueDate.textContent.trim().replace("    ,","").replace("th day of ","");
                const dateFormat = (new Date(dateElements).toLocaleDateString('fr-CA'));
                wrapElementDate(document, "issue-date", dateFormat + "T00:00:00");
