    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                var level4Elements = Array.from(document.querySelectorAll(".MarginalNote"));
                level4Elements = level4Elements.slice(0, level4Elements.length - 1)
                ...
                Array.prototype.forEach.call(document.querySelectorAll(".legisHeader,.wb-invisible,nav,.PITLink,.mfp-hide"), function (node) { node.remove(); });
