    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                Array.prototype.forEach.call(document.querySelectorAll(".col-md-9 > div > div > section > ul > li > div > p > a"), function (node) { node.remove(); });
                Array.prototype.forEach.call(document.querySelectorAll(".col-md-9 > div > div > section > p > strong "), function (node) { node.remove(); });
                Array.prototype.forEach.call(document.querySelectorAll(".col-md-9 > #right-panel"), function (node) { node.remove(); });
                Array.prototype.forEach.call(document.querySelectorAll(".col-md-9 > div > div > section > section > p > a"), function (node) { node.remove(); });
                Array.prototype.forEach.call(document.querySelectorAll(".col-md-9 > div > div > section > section > ul > li > div > p > a"), function (node) { node.remove(); });
