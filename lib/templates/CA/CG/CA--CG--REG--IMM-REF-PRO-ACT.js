        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                // #############
                   ...
                   Array.prototype.forEach.call(document.querySelectorAll("section.mfp-hide"),function (node){node.remove();});
                   ...
                   const removeelements= document.querySelectorAll("section.mfp-hide");
                   for(var ele of removeelements){
                    console.log(ele);
                    ele.textContent="";
                   }
                ...
                // });
                  wrapElements(document, level2Elements3, "level3");
                   ...
                   const level2Elementsub = document.querySelectorAll(".col-md-9 > div > div > section > h4.Subheading");
                   wrapElements(document, level2Elementsub, "level4");

                   const level2Elements4 = document.querySelectorAll(".col-md-9 > div > div > section > .MarginalNote");
                   for(var i of level2Elements4){
                      var iteam=   i.nextElementSibling?.querySelector("strong");
                      wrapElements(document,[iteam,i],"level5",true);
                   ...
                   wrapElements(document, level2Elements5, "level6");


                   const footnote= document.querySelectorAll(".ProvisionList>li> .Footnote");
