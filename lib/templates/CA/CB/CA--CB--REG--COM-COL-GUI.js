    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                const footnoteElement = document.querySelectorAll('.wb-fnote > dl > dd > .fn-rtn');
                ...
                Array.prototype.forEach.call(document.querySelectorAll(".list-unstyled, .alert.alert-info, .row:not(.pagedetails), .wb-fnote dl > dt, .wb-inv, .row.pagedetails .text-right"), function (node) { node.remove(); });
