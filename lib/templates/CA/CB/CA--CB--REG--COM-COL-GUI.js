    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                Array.prototype.forEach.call(document.querySelectorAll(".list-unstyled, .alert.alert-info, .row:not(.pagedetails), .row.pagedetails .text-right, .wb-fnote > dl > dt"), function (node) { node.remove(); });
