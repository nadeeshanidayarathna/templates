    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                wrapElementDate(document, "issue-date", "2014-04-29" + "T00:00:00");
                ...
                wrapElements(document, level6Element, "level5");

                const footnoteElement = document.querySelectorAll('.c39')[1];
