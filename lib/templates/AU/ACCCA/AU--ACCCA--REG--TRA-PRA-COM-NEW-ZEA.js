    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                wrapElements(document, level1Element, "level1");
                wrapElementDate(document, "issue-date", "1994-07-01" + "T00:00:00");
                wrapElementDate(document, "effective-date", "1994-07-01" + "T00:00:00");
                ...
                Array.prototype.forEach.call(document.querySelectorAll(".MsoFooter"), function (node) { node.remove(); });
