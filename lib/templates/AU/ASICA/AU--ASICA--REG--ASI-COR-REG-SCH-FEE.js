    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                const issueDatesText = document.querySelectorAll('.LI-Fronttext');
                wrapElementDate(document, "issue-date", "2017-03-10" + "T00:00:00");
                wrapElementDate(document, "effective-date", "2017-03-11" + "T00:00:00");
