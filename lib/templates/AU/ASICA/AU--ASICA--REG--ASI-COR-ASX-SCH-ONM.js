    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                wrapElementDate(document, "issue-date", "2016-12-09" + "T00:00:00");
                wrapElementDate(document, "effective-date", "2017-02-07" + "T00:00:00");
                ...
                const level4Element = document.querySelectorAll('.LI-SectionHeading');
                for (const elements of level4Element) {
                    if (elements.textContent.trim().match(/^Division/)) {
