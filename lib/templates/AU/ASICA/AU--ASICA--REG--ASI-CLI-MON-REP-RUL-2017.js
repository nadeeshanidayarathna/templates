    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                // TODO:
                const level1Element = document.querySelector(".WordSection1 > p:nth-child(3)");
                wrapElement(document, level1Element, "level1");

                wrapElementDate(document, "issue-date", "2022-03-10" + "T00:00:00");
                wrapElementDate(document, "effective-date", "2022-03-10" + "T00:00:00");
                // ################
                // # content:info #
                // ################
                ...
                const level2Elements = document.querySelectorAll('.MIRHeading1');
                wrapElements(document, level2Elements, 'level2');

                const level22Elements = document.querySelectorAll('.MIRHeading1Chapter');
                wrapElements(document, level22Elements, 'level2');

                const level3Elements = document.querySelectorAll('.MIRHeading2');
                wrapElements(document, level3Elements, 'level3');

                const level31Elements = document.querySelectorAll('.MIRHeading2Part');
                wrapElements(document, level31Elements, 'level3');

                const level4Elements = document.querySelectorAll('.MIRHeading3');
