    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                const level4Element = document.querySelectorAll('.MIRHeading3Rule');
                wrapElements(document, level4Element, "level4");

                // removing unwanted content from ease-content
                Array.prototype.forEach.call(document.querySelectorAll(".MsoToc2, .MsoToc1, .Heading1nonumber"), function (node) { node.remove(); });
