    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                wrapElementDate(document, "issue-date", "2022-09-07" + "T00:00:00");
                wrapElementDate(document, "effective-date", "2022-09-09" + "T00:00:00");
                // ################
                // # content:info #
                // ################
                ...
                const level4Elements = document.querySelectorAll('.LI-BodyTextNumbered > b');
