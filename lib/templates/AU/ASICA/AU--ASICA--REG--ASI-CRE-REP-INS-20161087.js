    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                // # root:info #
                // #############
                const level1Element = document.querySelectorAll(".LI-Title")[0];
                wrapElement(document, level1Element, "level1");
                wrapElementDate(document, "issue-date", "2016-11-02" + "T00:00:00");
                wrapElementDate(document, "effective-date", "2017-02-01" + "T00:00:00");
                // ################
                // # content:info #
                // ################
