    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                wrapElementDate(document, "issue-date", "2014-12-12" + "T00:00:00");
               // wrapElementDate(document, "effective-date", "2018-03-01" + "T00:00:00");
                // ################
                // # content:info #
                // ################
                ...
                const level2Elements = document.querySelectorAll('.Style6');
                wrapElements(document, level2Elements, 'level2');

                const level3Elements = document.querySelectorAll('.Style1 > b');
