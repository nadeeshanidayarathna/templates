    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                wrapElementDate(document, "issue-date", "2007-04-28" + "T00:00:00");
                ...
                const level3Elements = document.querySelectorAll('.ActHead6');
                wrapElements(document, level3Elements, "level3", group = false);

                const level4Elements = document.querySelectorAll('.Section3 .ActHead5, .Section4 .ActHead7');
                wrapElements(document, level4Elements, "level4", group = false);

                // removing unwanted content from ease-content
                Array.prototype.forEach.call(document.querySelectorAll(".Section1 img, .Section2"), function (node) { node.remove(); });
