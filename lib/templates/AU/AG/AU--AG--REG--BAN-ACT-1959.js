    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                const level3Elements = document.querySelectorAll('.WordSection3 .ActHead2 , .WordSection4  > p:first-of-type, .ENotesHeading1');
                wrapElements(document, level3Elements, "level3", group = false);

                const level4Elements = document.querySelectorAll('.WordSection3 .ActHead3, .WordSection4  .ActHead1, .WordSection5  .ActHead1, .ENotesHeading2');
                ...
                wrapElements(document, level5Elements, "level5", group = false);

                const level6Elements = document.querySelectorAll('.WordSection3 .ActHead5');
                wrapElements(document, level6Elements, "level6", group = false);
