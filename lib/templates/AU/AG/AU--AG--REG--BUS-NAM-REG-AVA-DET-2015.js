    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                wrapElementDate(document, "issue-date", "2020-12-22" + "T00:00:00");
                wrapElementDate(document, "effective-date", "2020-11-28" + "T00:00:00");
                // ################
                // # content:info #
                // ################
                ...
                const level2Elements = document.querySelectorAll('.HP');
                wrapElements(document, level2Elements, 'level2');

                const level21Elements = document.querySelectorAll('.ENotesHeading1');
                wrapElements(document, level21Elements, 'level2');



                const level3Elements = document.querySelectorAll('.HD');
                wrapElements(document, level3Elements, 'level3');

                const level31Elements = document.querySelectorAll('.Scheduletitle');
                wrapElements(document, level31Elements, 'level2');

                const level41Elements = document.querySelectorAll('.ENotesHeading2');
                wrapElements(document, level41Elements, 'level3');

                const level4Elements = document.querySelectorAll('.HR');
                wrapElements(document, level4Elements, 'level4');

                const level5Elements = document.querySelectorAll('.Schedulepart');
                wrapElements(document, level5Elements, 'level3');
