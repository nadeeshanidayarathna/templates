    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                // # root:info #
                // #############
                const rootTitle = "ARS 114.0 Standardised Approach – Operational Risk (applies to both Level 1 & Level 2 forms)";
                wrapElementLevel1(document, rootTitle);

                const DateElement = document.querySelectorAll('.MsoNormal')[9];
                let fullText = DateElement.textContent;
                let check = (fullText.indexOf("on") + 2)
