    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                // # root:info #
                // #############
                const level1Text = "LRS 750.0 Claims and Disputes";
                wrapElementLevel1(document, level1Text);
                wrapElementDate(document, "issue-date", "2018-10-23" + "T00:00:00");
                // ################
                // # content:info #
                // ################
                ...
                const level2Elements = document.querySelectorAll("b")[5];
