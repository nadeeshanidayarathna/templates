    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                const level3Elements = document.querySelectorAll('.WordSection3 .ActHead1');
                wrapElements(document, level3Elements, "level3");

                const level4Elements = document.querySelectorAll('.WordSection3 .ActHead2, .WordSection4 .ActHead1,  .WordSection5 .ENotesHeading1');
                wrapElements(document, level4Elements, "level4");

                const level5Elements = document.querySelectorAll('.WordSection3 .ActHead3, .WordSection5 .ENotesHeading2');
                wrapElements(document, level5Elements, "level5");

                const level6Elements = document.querySelectorAll('.WordSection3 .ActHead4');
                wrapElements(document, level6Elements, "level6");

                const level7Elements = document.querySelectorAll('.WordSection3 .ActHead5');
                wrapElements(document, level7Elements, "level7");
