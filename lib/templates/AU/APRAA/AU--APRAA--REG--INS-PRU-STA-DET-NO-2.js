    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                const level1Elements2 = document.querySelectorAll(".ActTitle");
                wrapElements(document, [level1Elements[0], level1Elements[1], level1Elements2[0]], "level1", group = true);
                ...
                var level2Element = Array.from(document.querySelectorAll("h1"));
                level2Element = level2Element.slice(5, level2Element.length)
