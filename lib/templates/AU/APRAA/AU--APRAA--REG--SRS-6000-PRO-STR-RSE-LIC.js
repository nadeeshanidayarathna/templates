        ...
        });
        {
            ...
            await page.evaluate(function process() {
             ...
             const level1Element = document.querySelector("#MainContent_pnlHtmlControls > div > .WordSection1 > p:nth-child(2)");
               //const level1Element = "SRS 531.0 Investment Flows";
              //var level1Element = "SRS 531.0 Investment Flows";
                wrapElement(document , level1Element , "level1");
        
                wrapElementDate(document, "issue-date", "2015-06-10" + "T00:00:00");
              //  wrapElementDate(document, "effective-date", "2015-04-29" + "T00:00:00");
                ...
                Array.prototype.forEach.call(document.querySelectorAll(".WordSection1 > p>span > img"), function (node) { node.remove(); });
               Array.prototype.forEach.call(document.querySelectorAll(".WordSection2 > p>span > img"), function (node) { node.remove(); });

                //  const level2Elements = document.querySelectorAll('h1');
                // wrapElements(document, level2Elements, 'level2');
  
                const level2Elements = document.querySelectorAll(".WordSection1 > p > b >span");
            ...
            if (level21Element.style.fontSize == '16pt') {
                ...
                const level31Elements = document.querySelectorAll('.WordSection2 > p > a >b> span[lang="X-NONE"]');
