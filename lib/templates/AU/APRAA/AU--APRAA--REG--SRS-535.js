            ...
            await page.evaluate(function process() {
             ...
             const level1Element = document.querySelector("#MainContent_pnlHtmlControls > div > .Section1 > p:nth-child(2)");
              ...
              //var level1Element = "SRS 531.0 Investment Flows";
                ...
                wrapElementDate(document, "issue-date", "2013-06-03" + "T00:00:00");
              //  wrapElementDate(document, "effective-date", "2015-04-29" + "T00:00:00");
                ...
                Array.prototype.forEach.call(document.querySelectorAll(".Section1 > p>a>span > img"), function (node) { node.remove(); });
