    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                // # root:info #
                // #############
                const rootTitle = "SIS Act - Approval of provision of benefits No. 1 of 2007";
                wrapElementLevel1(document, rootTitle);

                const DateElements = document.querySelectorAll('.Paragraph');
                ...
                Array.prototype.forEach.call(document.querySelectorAll(".Section1>p>img"), function (node) { node.remove(); });
