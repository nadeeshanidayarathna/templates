    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                const rootTitle = "LRS 110. 1 Prescribed Capital Amount (applies to both LRF 110.1 - SF, GF & LRF 110.2 - Entity)";
                ...
                const elements = document.querySelectorAll(".AS");
                ...
                for(const element of section5Elements){
                    if(element.textContent.startsWith("LRF_110_1")){
                        wrapElement(document, element, "level2");
                    }
                    else if(element.textContent.startsWith("Instructions for specific items")){
                        wrapElement(document, element, "level3");
                    }
                ...
                const section7Elements = document.querySelectorAll(".Section7 > .MsoNormal > b > span");
                for(const element of section7Elements){
                    if(element.textContent.startsWith("LRF_110_2")){
                        wrapElement(document, element, "level2");
                    }
                    else if(element.textContent.startsWith("Instructions for specific items")){
                        wrapElement(document, element, "level3");
