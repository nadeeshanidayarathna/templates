    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                wrapElementDate(document, "issue-date", "2016-07-19" + "T00:00:00");
                ...
                const level2Elements = document.querySelectorAll('h6');
                ...
                wrapElements(document, level31Elements, 'level4');
                ...
                const level41Elements = document.querySelectorAll('h5>span');
                for (const level41Element of level41Elements) {
                    if (level41Element.textContent.match(/^\d+\.\d+\.\d/)) {
                        const level41text = /^\d+\.\d+\.\d/.exec(level41Element.textContent);
                        level41Element.outerHTML = level41Element.outerHTML.replace(level41text, "<div title=\"level6\" class=\"level6\">" + level41text + "</div>");
                    }
                }
