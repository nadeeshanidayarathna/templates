    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                wrapElementDate(document, "issue-date", "2006-02-01" + "T00:00:00");
             //  wrapElementDate(document, "effective-date", "2022-11-14" + "T00:00:00");
                // ################
                // # content:info #
                // ################
               ...
               const footnoteElement = document.querySelectorAll('h3');
               wrapElements(document, footnoteElement, "level2");
