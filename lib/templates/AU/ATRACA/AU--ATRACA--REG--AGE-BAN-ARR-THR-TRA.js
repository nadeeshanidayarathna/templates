    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                wrapElementDate(document, "issue-date", "2019-10-17" + "T00:00:00");
                // ################
                // # content:info #
                // ################
                const content = document.querySelectorAll(".region-content")[0];
               ...
               Array.prototype.forEach.call(document.querySelectorAll(".au-page-alerts--info,#block-webform"), function (node) { node.remove(); });
