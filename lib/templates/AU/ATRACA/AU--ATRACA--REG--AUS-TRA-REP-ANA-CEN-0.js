    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                const issueDates = document.querySelector(".WordSection1 > p:nth-of-type(6) > span");
                ...
                const effectiveDates = document.querySelector(".WordSection1 > p:nth-of-type(4) > span");
