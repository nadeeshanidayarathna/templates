    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                // # root:info #
                // #############
                const level1Text = "Guidelines for exercise of investment responsibilities."
                wrapElementLevel1(document, level1Text);
                wrapElementDate(document, "issue-date", "1971-08-11" + "T00:00:00");
                // ################
                // # content:info #
                // ################
               ...
               wrapElement(document, level2Elements[3], "level2");
