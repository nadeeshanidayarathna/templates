    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                // # root:info #
                // #############
                wrapElementLevel1(document, "Statutory Revisions affecting cancellation, conditional renewal and nonrenewal of commercial risk, professional liability and public entity insurance policies in New York State.");
                ...
                for (const elements of level2Elements) {
                    if (elements.textContent.trim().match(/^[A-Z]+\s[A-Z]+/)) {
