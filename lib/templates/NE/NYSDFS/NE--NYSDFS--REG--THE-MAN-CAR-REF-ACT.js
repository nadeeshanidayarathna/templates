    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                wrapElementDate(document, "issue-date", "1997-03-25" + "T00:00:00");
                // ################
                // # content:info #
                // ################
                ...
                const level3MissingElement = document.querySelectorAll("p")[20];
                wrapElement(document, level3MissingElement, "level3");
