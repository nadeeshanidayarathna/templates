    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                const level2Element1 = document.querySelectorAll(".cltext > .underb");
                wrapElements(document, level2Element1, "level2");
                const level2Element2 = document.querySelectorAll(".tcenter > .tbold")[0];
                wrapElement(document, level2Element2, "level2");
                const level2Element3 = document.querySelectorAll(".tcenter > .tbold")[1];
