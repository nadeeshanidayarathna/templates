    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                wrapElementDate(document, "issue-date", "2012-04-12" + "T00:00:00");
                // ################
                // # content:info #
                // ################
                ...
                const level2Element = Array.from(document.querySelectorAll("b,.cltext>p>strong>u")).slice(0,4);
                ...
                const level3Elements = document.querySelectorAll("ol#balpha>li");
