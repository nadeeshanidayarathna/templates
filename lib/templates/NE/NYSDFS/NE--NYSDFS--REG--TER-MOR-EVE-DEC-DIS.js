    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                // # root:info #
                // #############
                const rootTitle = "Termination Moratorium in the Event of Declared Disaster; Homeowner Windstorm Deductibles and Wrap Around Endorsements";
                ...
                for (const date of dates) {
                    const dateText = date.childNodes[2].textContent.trimStart(); // customized match to handle non-standard date
