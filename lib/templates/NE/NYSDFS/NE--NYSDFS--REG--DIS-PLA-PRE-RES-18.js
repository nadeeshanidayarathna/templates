    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                const level2Elements1 = document.querySelector(".cltext > p > u > b");
                wrapElement(document, level2Elements1, "level2");

                const level2Elements2 = Array.from(document.querySelectorAll(".cltext > p > strong > u")).slice(0,2);
                wrapElements(document, level2Elements2, "level2");
                    
                const level2Elements3 = document.querySelectorAll(".tcenter>p:first-of-type"); 
