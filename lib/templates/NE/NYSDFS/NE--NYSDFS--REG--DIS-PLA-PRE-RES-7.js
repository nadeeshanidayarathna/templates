    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                const level2Elements1 = Array.from(document.querySelectorAll(".cltext > .underb")).slice(0,2);
                wrapElements(document, level2Elements1, "level2");

                const level2Element2 = document.querySelector(".cltext > p > u");
                wrapElement(document, level2Element2, "level2");

                const level2Element3 = document.querySelector(".tcenter>p:first-of-type");
