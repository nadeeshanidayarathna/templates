    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                const level1Text = level1Element.textContent.substring(4,level1Element.textContent.length)
                wrapElementLevel1(document, level1Text);
                wrapElementDate(document, "issue-date", "1993-09-15" + "T00:00:00");
                // ################
                // # content:info #
                // ################
                ...
                wrapElement(document, content, "ease-content");
                 ...
                 for(const contentChild of level2Elements){
                    if(contentChild.textContent.match(regex)){
                        const level2Text = contentChild.textContent.match(regex)[1];  
