    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                // # root:info #
                // #############
                const rootTitle = "Insurance Department Regulation 68 Lawsuit";
                ...
                for (const date of dates) {
                    if (date.textContent.match(regex)) {
                        const issueDate = new Date(date.textContent.trimEnd().replace(",  ", ", ")); // customized match to handle non-standard date
