    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                // # root:info #
                // #############
                const rootTitle = document.querySelector(".dataTable tr:nth-of-type(2) > td:nth-of-type(2)");
                ...
                const level3Elements = document.querySelectorAll(".cltext > .ind05b");
                wrapElements(document, level3Elements, "level3");

                const level4Elements = document.querySelectorAll(".cltext > .ind10b");
                wrapElements(document, level4Elements, "level4");

                const level5Elements = document.querySelectorAll(".cltext > .ind15");
