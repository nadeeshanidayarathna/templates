    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                // #############
                // TODO:
                const rootTitle = "Reporting Inter-company balances, Federal tax recoverable and unauthorized reinsurance recoverable in Annual Statement."
                ...
                const level2Element = document.querySelectorAll(".indpre > p");
                for(const contentChild of level2Element){
                    if(contentChild.textContent.indexOf(".") == 1){
