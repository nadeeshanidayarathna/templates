    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                // # root:info #
                // #############
                const level1Element = document.querySelectorAll("td>p>strong")[1];
                wrapElement(document, level1Element, "level1");
                wrapElementDate(document, "issue-date", "2013-07-24" + "T00:00:00");
                // ################
                // # content:info #
                // ################
                ...
                wrapElement(document, content, "ease-content");
                 ...
                 const footnoteElements= allPTags.slice(allPTags.length-4,allPTags.length-1);
