    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                // TODO:
                const level1Element = document.querySelector(".content > div > div:nth-child(1)");
                ...
                Array.prototype.forEach.call(document.querySelectorAll(".content > div > .newsc > p:nth-child(1)"), function (node) { node.remove(); });

            //    const level2Element = document.querySelectorAll('h2');
            //    wrapElements(document, level2Element, "level2");

                const footnoteElement = document.querySelectorAll(".content > div > div > div > div");
