    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                // TODO:
                const level1Element = document.querySelector(".text-yellow");
               ...
               Array.prototype.forEach.call(document.querySelectorAll(".btn-group, .card-header"), function (node) { node.remove(); });
                // TODO:
