...
const scraper = async function download(url, sp, path) {
    try {
        ...
        });
        {
            ...
            // 2.Identify
            // 3.Wrap
            await page.waitForSelector(".c28");
            await page.evaluate(function process() {
                ...
                wrapElementDate(document, "issue-date", "2004-07-30" + "T00:00:00");
                ...
                // Scope
                const contentElement = document.querySelectorAll(".c28")[0];
                ...
                //Footnotes
                const footnoteElement = document.querySelectorAll(".footnotes")
