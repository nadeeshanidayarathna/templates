    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                wrapElementDate(document, "issue-date", "2021-12-13" + "T00:00:00");
                wrapElementDate(document, "effective-date", "2021-12-13" + "T00:00:00");
                ...
                //Footnotes
                const footnoteElement = document.querySelectorAll(".fn")
