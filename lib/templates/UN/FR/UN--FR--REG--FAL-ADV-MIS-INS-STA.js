    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                const effectiveDates = document.querySelectorAll('dd')[4];
                ...
                for (const level2Element of level2Elements) {
                    if (level2Element.textContent.trim().match(/^[A-Z]{2}.*/)) {
                ...
                const level4Elements = document.querySelectorAll('.doc-content-area h3, .section > .sectno');
                ...
                Array.prototype.forEach.call(document.querySelectorAll(".end-matter, .printed-page, .text, .back, .regulatory-table-of-contents"), function (node) { node.remove(); });
