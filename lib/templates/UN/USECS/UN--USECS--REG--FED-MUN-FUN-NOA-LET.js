    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                // # root:info #
                // #############
                wrapElementLevel1(document, "SEC Guidance Update No. 2013-02");
                ...
                Array.prototype.forEach.call(document.querySelectorAll("td img, .footer"), function (node) { node.remove(); });
