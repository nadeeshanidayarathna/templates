    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                wrapElementDate(document, "issue-date", "2022-03-29T00:00:00");
                ...
                const footNote = document.querySelectorAll(".MsoFootnoteText");
                wrapElements(document, footNote, "footnote", group = false);
