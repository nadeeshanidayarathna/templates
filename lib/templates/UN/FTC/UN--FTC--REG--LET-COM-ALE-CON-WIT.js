    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                wrapElementDate(document, "issue-date", "2006-12-07" + "T00:00:00");
                //wrapElementDate(document, "effective-date", "2018-09-04" + "T00:00:00");
                // ################
                // # content:info #
                // ################
                ...
                const level3Elements = document.querySelectorAll('.MsoEndnoteText');
