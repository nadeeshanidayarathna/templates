    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                // # root:info #
                // #############
                wrapElementLevel1(document, "Incoming Letter from the Generic Pharmaceutical Association, Inc., dated July 16, 2012 [Public Record Version]");
                wrapElementDate(document, "issue-date", "2012-07-16" + "T00:00:00");
