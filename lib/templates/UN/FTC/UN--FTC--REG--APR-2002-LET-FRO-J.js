    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                // # root:info #
                // #############
                const rootTitle = "April 8, 2002 Letter From J. Howard Beales, Director, Bureau of Consumer Protection, to the American Bar Association";
                wrapElementLevel1(document, rootTitle);
                const issueDate = document.querySelector("h2").textContent;
