        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                const level1Element = document.querySelector('h1');
                 ...
                 const issueDates=document.querySelectorAll(".field__item >p")[40]
                 const firstdate = issueDates.firstChild;
                 console.log(firstdate .innerText);
                 console.log("Issue date : "+firstdate.textContent);
                ...
                const contentElement = document.querySelector('body');
                 ...
                 const level2Element = document.querySelectorAll('.field__item>H2');
                 for (let i = 11; i < level2Element.length; i++) {
                   wrapElement(document, level2Element[i], "level2");
                 }
                 const level3Element = document.querySelectorAll('.field__item>H3');
                 for (let i = 6; i < level3Element.length; i++) {
