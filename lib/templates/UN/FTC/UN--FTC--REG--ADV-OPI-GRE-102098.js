  ...
  try {
    ...
    });
    {
      ...
      await page.evaluate(function process() {
        ...
        wrapElementDate(document, "issue-date", "1998-10-20T00:00:00");
        ...
        const level2Element = document.querySelectorAll("p strong em, p em strong");
        wrapElements(document, level2Element, "level2");

        const footnoteElement = document.querySelectorAll("p")[51];
