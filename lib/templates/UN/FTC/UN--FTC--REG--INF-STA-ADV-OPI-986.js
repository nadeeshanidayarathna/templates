  ...
  try {
    ...
    });
    {
      ...
      await page.evaluate(function process() {
        ...
        wrapElementDate(document, "issue-date", "1998-08-12T00:00:00");
        ...
        //     ".block-content-container , .usa-footer,.usa-footer__return-to-top,.banner,.usa-skipnav, .region-header,.usa-nav"
        //   ),
        //   function (node) {
        //     node.remove();
        //   }
