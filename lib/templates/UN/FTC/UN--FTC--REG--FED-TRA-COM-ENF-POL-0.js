    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                wrapElementDate(document, "issue-date", "2016-11-15" + "T00:00:00");
               ...
               // Array.prototype.forEach.call(document.querySelectorAll("#MainContent_pnlHtmlControls > div > .WordSection2"), function (node) { node.remove(); });
                ...
                const level2Elements = document.querySelectorAll('div >.MsoEndnoteText');
               wrapElements(document, level2Elements, 'footnote');
