    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                const level2Element = document.querySelectorAll(".lvls");
                ...
                const footnoteElementN = document.querySelectorAll(".MsoEndnoteText");
                wrapElements(document, footnoteElementN, "footnote");

                const footnoteElements = document.querySelectorAll('div[id*="edn"]');
                for(const footnoteElement of footnoteElements){
                    if(footnoteElement.textContent.match(/^\[\d]/))
