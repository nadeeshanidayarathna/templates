  ...
  try {
    ...
    });
    {
      ...
      await page.evaluate(function process() {
        ...
        const level2Element = document.querySelectorAll(".field__item >p:nth-of-type(5),.field__item >p:nth-of-type(7),.field__item >p:nth-of-type(9),.field__item >p:nth-of-type(11),.field__item >p:nth-of-type(13),.field__item >p:nth-of-type(15),.field__item >p:nth-of-type(17),.field__item >p:nth-of-type(19),.field__item >p:nth-of-type(21),.field__item >p:nth-of-type(23)");
