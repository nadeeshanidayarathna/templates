    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                wrapElementDate(document, "issue-date", "2022-06-16" + "T00:00:00");
              //  wrapElementDate(document, "effective-date", "2015-04-29" + "T00:00:00");
               ...
               const level21Elements = document.querySelectorAll('h1');
               ...
               const level5Elements = document.querySelectorAll('div>div >.footnotedescription');
