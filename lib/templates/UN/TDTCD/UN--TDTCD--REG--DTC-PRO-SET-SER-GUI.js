    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                // # root:info #
                // #############
                const rootTitle = "DTC PROCEDURES - Settlement Service Guide";
                ...
                //added h6 for test
                // h3 > h6
                const level2ElementN = document.querySelectorAll('h3');
                wrapElements(document, level2ElementN, "level2");

                // const level3ElementN = document.querySelectorAll('h6');
                ...
                const footnoteElement = document.querySelectorAll('.cc81');
