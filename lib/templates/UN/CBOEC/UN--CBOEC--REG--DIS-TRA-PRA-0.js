    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                const rootTitle = "Disruptive Trading Practices";
                wrapElementLevel1(document, rootTitle);
                wrapElementDate(document, "issue-date", "2022-06-24T00:00:00");
                ...
                const level2Element = document.querySelectorAll(".lvlTitle");
                ...
                const level5Element = document.querySelectorAll("h2");
