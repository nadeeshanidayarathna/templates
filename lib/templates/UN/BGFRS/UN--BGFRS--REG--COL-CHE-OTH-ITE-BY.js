        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                let fullText = effectiveDateElement.textContent
                        ...
                        wrapElementDate(document, "issue-date", "2022-06-06" + "T00:00:00");
                ...
                Array.prototype.forEach.call(document.querySelectorAll(".end-matter, .printed-page, .text, .back"), function (node) { node.remove(); });
