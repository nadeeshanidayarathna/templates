  ...
  try {
    ...
    });
    {
      ...
      await page.evaluate(function process() {
        ...
        // #############
        const rootTitle =
          "Nasdaq Futures, Inc. Rulebook - Reference Guides & Alerts - Futures Trader Alerts #2017-6";
        ...
        const level2Element = level2Elements.childNodes[4].textContent.replace(
          /&/g,
          "&amp;"
        );
        level2Elements.outerHTML = level2Elements.outerHTML.replace(
          level2Element,
          '<div title="level2" class = "level2">' + level2Element + "</div>"
        );

        const level3Elements = document.querySelectorAll(
          ".newscontentbox2 > p > strong"
        );
        ...
        Array.prototype.forEach.call(
          document.querySelectorAll(
            ".footnote2, hr, .genTableNews > table > tbody > tr > th"
          ),
          function (node) {
            node.remove();
          }
