    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                // # root:info #
                // #############
                const rootTitle = "Nasdaq Futures, Inc. Rulebook - Reference Guides & Alerts - Futures Trader Alerts #2018-2";
                ...
                const level2Element = level2Elements.childNodes[4].textContent.replace(/&/g, "&amp;");
