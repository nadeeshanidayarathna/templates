    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                // # root:info #
                // #############
                const rootTitle = "Nasdaq Futures, Inc. Rulebook - Reference Guides & Alerts - Futures Trader Alerts #2018-10";
                ...
                level2Elements.outerHTML = level2Elements.outerHTML.replace("Initial Listing &amp; Margin Notice for 13 Tanker Freight Futures Contracts for Trade Date May 11, 2018" , "<div title=\"level2\" class = \"level2\">" + level2Element + "</div>");

                const level3Elements = document.querySelectorAll('.newscontentbox2 > p > strong');
