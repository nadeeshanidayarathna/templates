    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                // # root:info #
                // #############
                const rootTitle = "Nasdaq Futures, Inc. Rulebook - Reference Guides & Alerts - Futures Trader Alerts #2015-12";
                ...
                Array.prototype.forEach.call(document.querySelectorAll(".footnote2, hr, .logo_print, #linkback, .optmkt > p , .optmkt > h2"), function (node) { node.remove(); });
