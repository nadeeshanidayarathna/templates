    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                // # root:info #
                // #############
                const rootTitle = "Nasdaq Futures, Inc. Rulebook - Reference Guides & Alerts - Futures Regulatory Alerts #2013 - 1";
                ...
                Array.prototype.forEach.call(document.querySelectorAll(".footnote2, hr, .newscontentbox, tr > th"), function (node) { node.remove(); });
