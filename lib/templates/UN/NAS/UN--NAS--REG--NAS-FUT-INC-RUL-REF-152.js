    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                // # root:info #
                // #############
                const rootTitle = "Nasdaq Futures, Inc. Rulebook - Reference Guides & Alerts - Futures Trader Alerts #2012-10";
                ...
                Array.prototype.forEach.call(document.querySelectorAll(".footnote2, hr, th, .newscontentbox"), function (node) { node.remove(); });
