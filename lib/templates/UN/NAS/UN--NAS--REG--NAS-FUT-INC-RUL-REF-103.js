    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                // # root:info #
                // #############
                const rootTitle = "Nasdaq Futures, Inc. Rulebook - Reference Guides & Alerts - Futures Trader Alerts #2009-1";
                ...
                Array.prototype.forEach.call(document.querySelectorAll(".footnote, hr, .newscontentbox"), function (node) { node.remove(); });
