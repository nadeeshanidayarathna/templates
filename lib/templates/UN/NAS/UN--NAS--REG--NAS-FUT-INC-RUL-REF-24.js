    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                // # root:info #
                // #############
                const rootTitle = "Nasdaq Futures, Inc. Rulebook - Reference Guides & Alerts - Futures Trader Alerts #2009-3";
                ...
                Array.prototype.forEach.call(document.querySelectorAll(".footnote2, hr, .footnote, .newscontentbox"), function (node) { node.remove(); });
