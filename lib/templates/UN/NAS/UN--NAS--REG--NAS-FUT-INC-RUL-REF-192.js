    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                // # root:info #
                // #############
                const rootTitle = "Nasdaq Futures, Inc. Rulebook - Reference Guides & Alerts - Futures Regulatory Alerts #2009 - 15";
                ...
                const level3Elements = document.querySelectorAll('.newscontentbox2 h3');
                wrapElements(document, level3Elements, "level3");

                const alterText = document.querySelector('.newscontentbox2 ul');
                for (const elements of alterText.childNodes) {
                    if (elements.tagName == 'LI') {
                        let texts = elements.innerHTML.replace(/sup>/g, "span>");
