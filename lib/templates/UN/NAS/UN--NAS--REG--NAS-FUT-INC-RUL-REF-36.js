    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                // # root:info #
                // #############
                const rootTitle = "Nasdaq Futures, Inc. Rulebook - Reference Guides & Alerts - Futures Trader Alerts #2015-4";
                ...
                const level2Elements = document.querySelectorAll('#NewsHeader > h2')[0];
                // const level2Element = level2Elements.childNodes[4].outerText;
                const level2Element = "Order Price Limit &amp; Non-Reviewable Range Changes for NFX Low Sulphur Gasoil Financial Futures";
                ...
                Array.prototype.forEach.call(document.querySelectorAll(".footnote2, hr"), function (node) { node.remove(); });
