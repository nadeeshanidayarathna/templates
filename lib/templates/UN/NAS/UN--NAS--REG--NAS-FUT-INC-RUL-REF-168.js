    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                // # root:info #
                // #############
                const rootTitle = "Nasdaq Futures, Inc. Rulebook - Reference Guides & Alerts - Futures Regulatory Alerts #2016 - 35";
                ...
                const level3Elements = document.querySelectorAll('.newscontentbox2 strong');
                wrapElements(document, level3Elements, "level3");

                // removing unwanted content from ease-content
                Array.prototype.forEach.call(document.querySelectorAll(".footnote2, hr, .genTableNews th"), function (node) { node.remove(); });
