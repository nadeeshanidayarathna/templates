    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                const issueDates = /[A-Z][a-z]+\s\d+,\s\d{4}/.exec(dates.childNodes[0].textContent.trim());
                const effectiveDates = /[A-Z][a-z]+\s\d+,\s\d{4}/.exec(dates.childNodes[3].textContent.trim());
