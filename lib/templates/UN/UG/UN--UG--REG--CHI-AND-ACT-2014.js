    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                const level5Element = document.querySelectorAll('#viewLegSnippet h5');
                wrapElements(document, level5Element, "level5");

                const level6Element = document.querySelectorAll('#viewLegSnippet h6');
                ...
                const alterText = document.querySelectorAll('.LegP1No, #viewLegSnippet .LegScheduleNo');
