    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                wrapElementDate(document, "issue-date", "2014-03-13" + "T00:00:00");
                wrapElementDate(document, "effective-date", "2014-03-13" + "T00:00:00");
                ...
                const level7Element = document.querySelectorAll('#viewLegSnippet h6');
                wrapElements(document, level7Element, "level7");
                ...
                const alterText = document.querySelectorAll('.LegP1No, #viewLegSnippet .LegScheduleNo, .LegCommentaryType, .LegChapterNo');
