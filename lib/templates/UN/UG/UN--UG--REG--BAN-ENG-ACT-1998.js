    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                wrapElementDate(document, "issue-date", "1998-04-23" + "T00:00:00");
                wrapElementDate(document, "effective-date", "1998-04-23" + "T00:00:00");
                ...
                const level2Element = document.querySelectorAll('h1.LegNo, h1.LegSchedulesTitle');
                wrapElements(document, level2Element, "level2");

                const level3Element = document.querySelectorAll('#viewLegSnippet h2');
                wrapElements(document, level3Element, "level3");

                const level4Element = document.querySelectorAll('#viewLegSnippet h3');
                wrapElements(document, level4Element, "level4");

                const level5Element = document.querySelectorAll('#viewLegSnippet h4');
                ...
                const level6Element = document.querySelectorAll('#viewLegSnippet h5');
                ...
                for (const elements of footnoteElement) {
                    if (elements.textContent.trim().match(/^F|^M/)) {
                        wrapElement(document, elements, "footnote");
                    }
                }

                const alterText = document.querySelectorAll('.LegP1No .LegAddition, .LegCommentaryType, .LegScheduleNo, .LegPartNo');
                ...
                Array.prototype.forEach.call(document.querySelectorAll("a"), function (node) { if (node.textContent.trim() == "" && node.childElementCount == 0) { node.remove();} });
