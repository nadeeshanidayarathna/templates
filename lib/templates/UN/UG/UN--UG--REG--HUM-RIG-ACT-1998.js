    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                wrapElementDate(document, "issue-date", "1998-11-09" + "T00:00:00");
                wrapElementDate(document, "effective-date", "1998-11-09" + "T00:00:00");
                ...
                const alterText = document.querySelectorAll('.LegP1No .LegAddition, .LegCommentaryType');
