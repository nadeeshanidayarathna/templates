    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                wrapElementDate(document, "issue-date", "1900-01-01" + "T00:00:00");
                // ################
                // # content:info #
                // ################
               ...
               const level2Elements = document.querySelectorAll("p .BoldText");
               for(const child of level2Elements){
                if(child.textContent.match(/^(?=[LXVI])(XC|XL|L?X{0,3})(IX|IV|V?I{0,3})\.\s[A-Z]/)){
