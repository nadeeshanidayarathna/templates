    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                wrapElementDate(document, "issue-date", "2022-05-16" + "T00:00:00");
                wrapElementDate(document, "effective-date", "2022-05-16" + "T00:00:00");
                // ################
                // # content:info #
                // ################
            ...
            //    wrapElements(document, level4Elements, 'level3');
               ...
               const level41Elements = document.querySelectorAll('body>div >table>tbody>tr>td>h3');
               wrapElements(document, level41Elements, 'level3');

               const level42Elements = document.querySelectorAll('body>div >table>tbody>tr>td>h4');
               wrapElements(document, level42Elements, 'level3');
