    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                const issueDates = document.querySelector('#metaField_kunngjort');
                ...
                const footNotes = document.querySelectorAll('tr');
                for (const footNote of footNotes) {
                    if (footNote.childNodes[0].className == 'morTag_fn fotnoteNummer') {
