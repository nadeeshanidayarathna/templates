    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                // # root:info #
                // #############
                const rootTitle = "Wyoming Campaign Guide";
                wrapElementLevel1(document, rootTitle);

                wrapElementDate(document, "issue-date", "2022-04-12" + "T00:00:00");
            ...
            // 4.Write
            await base.writePage(page, url, sp, path, true, true, false, 'latin1');
            await page.close();
        }
