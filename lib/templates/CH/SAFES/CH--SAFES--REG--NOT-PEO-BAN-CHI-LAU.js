    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                let level2Element = [elements[4], elements[44]];
                ...
                for (const level3Elements of elements) {
                    if (level3Elements.textContent.trim().charAt(0) == "第" && level3Elements.textContent.trim().charAt(2) == "章") {
                        ...
                        level3Elements.outerHTML = level3Elements.outerHTML.replace(level4Element, "<div class=\"level4\" title=\"level4\">" + level4Element + "</div>");
