    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                wrapElementDate(document, "issue-date", "2015-05-08" + "T00:00:00");
                ...
                var parserRules = [
                    { pattern: /\s*([一二三四五六七八九]、)(.*)/g, replacement: '<p class="number">$1</p><p>$2</p>' }
                  ];
                  
                document.querySelectorAll('.MsoNormal').forEach(function(tag) {
