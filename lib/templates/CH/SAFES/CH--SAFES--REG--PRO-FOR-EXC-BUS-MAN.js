    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                const level2Elements = document.querySelectorAll('strong');
                ...
                for (const level3Elements of level3Text) {
                    if (level3Elements.textContent.trim().charAt(0) == "第" && level3Elements.textContent.trim().charAt(2) == "条") {
                        const level3Element = /第\W条/.exec(level3Elements.textContent);
                        ...
                        const level3Element = /第\W\W条/.exec(level3Elements.textContent);
                        level3Elements.outerHTML = level3Elements.outerHTML.replace(level3Element, "<div class=\"level3\" title=\"level3\">" + level3Element + "</div>");
                    } else if (level3Elements.textContent.trim().charAt(0) == "第" && level3Elements.textContent.trim().charAt(4) == "条") {
                        const level3Element = /第\W\W\W条/.exec(level3Elements.textContent);
                        level3Elements.outerHTML = level3Elements.outerHTML.replace(level3Element, "<div class=\"level3\" title=\"level3\">" + level3Element + "</div>");
                    }
                }
                let i = 0;
                const elements = document.querySelectorAll('p');
                for (const footnoteElement of elements) {
                    if (i > 269) {
