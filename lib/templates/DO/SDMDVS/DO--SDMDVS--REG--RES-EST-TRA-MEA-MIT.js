    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                wrapElementDate(document, "issue-date", "2022-03-30" + "T00:00:00");
            ...
            const level3Elements = document.querySelectorAll('p>b>span');
            wrapElements(document, level3Elements, 'level3');

            const level4Elements = document.querySelectorAll('p>span>span');
            wrapElements(document, level4Elements, 'level4');

            //      const level4Elements = document.querySelectorAll('p>b>span');
            //    for (const level4Element of level4Elements) {
            //        if (level4Element.textContent.startsWith('[I]+.')) {
            //            const level4text = level4Element.textContent.match(/[I]+./);
