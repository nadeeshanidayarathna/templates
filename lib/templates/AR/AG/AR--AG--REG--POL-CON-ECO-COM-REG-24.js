    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                // # root:info #
                // #############
                const rootTitle = document.querySelectorAll(".c295");
                ...
                const level3ElementsN = document.querySelectorAll(".cc15");
                wrapElements(document, level3ElementsN, "level4");

                const footnoteElement = document.querySelectorAll(".cc116");
