    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                // # root:info #
                // #############
                const level1Text = "Pollution Control and Ecology Commission - Regulation 30: Hazardous Substances Site Priority List";
                wrapElementLevel1(document, level1Text);
                wrapElementDate(document, "issue-date", "2010-06-03" + "T00:00:00");
                // ################
                // # content:info #
                // ################
