    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                // # root:info #
                // #############
                const level1Text = "Department of Commerce - Rules for the Northeast Delta Zone of Arkansas for Boll Weevil Eradication in 2005";
                wrapElementLevel1(document, level1Text);
                wrapElementDate(document, "issue-date", "2005-06-28" + "T00:00:00");
                // ################
                // # content:info #
                // ################
