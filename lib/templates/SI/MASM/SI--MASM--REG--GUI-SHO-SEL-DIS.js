    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                // # root:info #
                // #############
                const level1Element = document.querySelector('h1.c36');
                wrapElement(document, level1Element, "level1");
                wrapElementDate(document, "issue-date", "2013-01-09" + "T00:00:00");
                ...
                const footnoteElement = document.querySelectorAll('p.c5');
