    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                // # root:info #
                // #############
                const rootTitle = document.querySelector(".c140 > span");
                ...
                const level3ElementsType2 = document.querySelectorAll("h3 > span");
                for(const element of level3ElementsType2){
                    if(element.textContent.match(/^\d.\d/)){
                        const level3ElementText = /^\d.\d/.exec(element.textContent);
