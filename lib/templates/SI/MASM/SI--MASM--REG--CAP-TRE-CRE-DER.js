    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                wrapElementDate(document, "issue-date", "2000-09-06" + "T00:00:00");
                ...
                const level4Element = document.querySelectorAll('h2, .h4');
                wrapElements(document, level4Element, "level4");

                const footnoteElement = document.querySelectorAll("div[id^='ftn'], #_ftn0");
