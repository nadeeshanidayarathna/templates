    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                const level1Element = "GUIDELINES ON CRITERIA FOR THE GRANT OF A CAPITAL MARKETS SERVICES LICENCE OTHER THAN FOR FUND MANAGEMENT AND REAL ESTATE INVESTMENT TRUST MANAGEMENT";
                wrapElementLevel1(document, level1Element);
                wrapElementDate(document, "issue-date", "2022-02-18" + "T00:00:00");
                ...
                for(const element of level3Elements){
                    if(element.textContent.match(/^\d{1,2}[.]\d{1,2}\s{1,}/)){
