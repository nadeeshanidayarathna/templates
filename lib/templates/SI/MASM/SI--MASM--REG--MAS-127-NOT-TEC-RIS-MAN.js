    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                const edateFormat = (new Date(effectiveDate.textContent).toLocaleDateString('fr-CA'));
                wrapElementDate(document, "effective-date", edateFormat + "T00:00:00");
                // ################
                // # content:info #
                // ################
                ...
                const level4Element = document.querySelectorAll(".nodeLvl");
