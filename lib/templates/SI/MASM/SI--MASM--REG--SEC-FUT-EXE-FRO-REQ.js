    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                const level2ElementsN = document.querySelectorAll(".schedule .sHdr");
                wrapElements(document, level2ElementsN, "level2");      
                
                const level2ElementsNs = document.querySelectorAll(".sRepHdr");
                wrapElements(document, level2ElementsNs, "level2"); 
                
                const level2ElementsDiv = document.querySelectorAll(".divtitle");
                wrapElements(document, level2ElementsDiv, "level2"); 

                const level2ElementsLegi = document.querySelectorAll(".LHHdrNoBold")[0];
                wrapElement(document, level2ElementsLegi, "level2"); 
