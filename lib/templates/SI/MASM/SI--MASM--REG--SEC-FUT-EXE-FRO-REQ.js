    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                const level2Elements = document.querySelector(".LHHdrNoBold");
                wrapElement(document, level2Elements, "level2"); 

                const levelElement = document.querySelectorAll(".prov1Txt strong");
                wrapElements(document, levelElement, "level3");

                const footnoteElement = document.querySelector(".FN");
