    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                const eFormat = (new Date(effectiveDate.textContent).toLocaleDateString('fr-CA'));
                wrapElementDate(document, "effective-date", eFormat + "T00:00:00");
                ...
                const level2Element = document.querySelector('h5');
                wrapElement(document, level2Element, "level2");

                const level3Element = document.querySelectorAll('h2');
                wrapElements(document, level3Element, "level3");

                const level4Element = document.querySelectorAll('.c25');
