    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                // # root:info #
                // #############
                const level1Element = document.querySelectorAll('h5');
                ...
                const level3ElementN = document.querySelectorAll('.lvl3');
                wrapElements(document, level3ElementN, "level3");

                const level3Element = document.querySelectorAll('h3');
                wrapElements(document, level3Element, "level3");

                const level4Element = document.querySelectorAll('.lvl4');
                wrapElements(document, level4Element, "level4");

                const footnoteElements = document.querySelector(".c18");
                wrapElement(document, footnoteElements, "footnote", group=true);
