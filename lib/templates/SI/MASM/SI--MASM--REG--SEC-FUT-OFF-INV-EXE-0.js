    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
               ...
               const level2ElementN = document.querySelectorAll(".sHdr");
               wrapElements(document, level2ElementN, "level2");

               const level3Element = document.querySelectorAll(".prov1Txt strong");
               wrapElements(document, level3Element, "level3");

               const level3ElementN = document.querySelectorAll(".sGrpHdrCaps DIV");
