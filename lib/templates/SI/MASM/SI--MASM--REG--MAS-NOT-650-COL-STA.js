    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                // # root:info #
                // #############
                const level1Element = document.querySelector('.c13 .c0');
                wrapElement(document, level1Element, "level1");

                const issueDate = document.querySelector('.c2 .c1');
                ...
                const effectiveDate = document.querySelector('.dateN');
                ...
                const level2Element = document.querySelectorAll('.c6 .c0');
                wrapElements(document, level2Element, "level2");

                const level2ElementN = document.querySelectorAll('.cc21');
                wrapElements(document, level2ElementN, "level3");
