        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                wrapElement(document, level1Element, "level1");
                 ...
                 wrapElementDate(document, "issue-date", "2015-11-30" + "T00:00:00");
               ...
               const level2Elements = document.querySelectorAll('h5');
               wrapElements(document, level2Elements, 'level2');
         
               const level3Elements = document.querySelectorAll('h2');
               wrapElements(document, level3Elements, 'level3');

                const level4Elements = document.querySelectorAll('.foot');
