    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                // # root:info #
                // #############
                const level1Element = document.querySelectorAll("h1")[7];
                ...
                const level2Elements = document.querySelectorAll("h1")[0];
                wrapElement(document, level2Elements, "level2");


                const level3Elements = Array.from(document.querySelectorAll("h2")).slice(0, 8);
                wrapElements(document, level3Elements, "level3");

                const level3Elements2 = document.querySelectorAll("h4");
