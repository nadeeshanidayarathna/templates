    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                wrapElementDate(document, "issue-date", "2007-07-02" + "T00:00:00");
            //  wrapElementDate(document, "effective-date", "2022-01-01" + "T00:00:00");
                ...
                const level7Element = document.querySelectorAll('.foot');
                wrapElements(document, level7Element, "footnote");
