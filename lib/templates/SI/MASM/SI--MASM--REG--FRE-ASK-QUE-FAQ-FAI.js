    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                const level1Element = "FREQUENTLY ASKED QUESTIONS (“FAQs”) ON FAIR AND BALANCED ADVERTISING AND OTHER ADVERTISING RESTRICTIONS";
                wrapElementLevel1(document, level1Element);
                wrapElementDate(document, "issue-date", "2018-12-06" + "T00:00:00");
