    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                wrapElementDate(document, "issue-date", "2018-09-28" + "T00:00:00");
                wrapElementDate(document, "effective-date", "2019-06-30" + "T00:00:00");
                ...
                for (const element of elements) {
                    if (element.tagName == 'H2') {
                        ...
                        for (const childs of element.childNodes) {
                            if (childs.textContent.trim().match(/^\d\.\d+$/)) {
                                wrapElement(document, childs, "level" + nextLevel);
                                break;
                            }
                        }
                    }
