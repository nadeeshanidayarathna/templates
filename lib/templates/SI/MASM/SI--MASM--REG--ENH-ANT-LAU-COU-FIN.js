    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                // # root:info #
                // #############
                const level1Element = document.querySelector('h1 .cc32');
                wrapElement(document, level1Element, "level1");

                const issueDate = document.querySelectorAll('.c11 .c1')[1];
                ...
                const level2Element = document.querySelectorAll('.c11 .c1')[0];
                ...
                const footnoteElement = document.querySelectorAll('.c76, .c80, .c3');
