    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                wrapElementDate(document, "issue-date", "2003-09-01" + "T00:00:00");
                ...
                const level2Element = document.querySelectorAll('h2, .h2');
                ...
                for (const elements of level3Element) {
                    if (elements.textContent.trim().match(/^\d/)) {
                        for (const element of elements.childNodes) {
                            if (element.textContent.trim().match(/^\d$|^\d\d$/)) {
                ...
                const footnoteElement = document.querySelector("div[id^='edn']");
