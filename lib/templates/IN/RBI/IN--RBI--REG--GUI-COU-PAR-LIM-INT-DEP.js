    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                wrapElementDate(document, "issue-date", "2002-01-17" + "T00:00:00");
                // ################
                // # content:info #
                // ################
                ...
                for (const contentChild of level2Elements) {
                    if (contentChild.textContent.match(regex)) {
                        ...
                        transformText = contentChild.textContent.match(regex)[2];
                        contentChild.outerHTML = contentChild.outerHTML.replace(level2Text + transformText, "<div title=\"level2\" class=\"level2\">" + level2Text + "</div> <p>" + transformText + "</p>");
                    }
                }
