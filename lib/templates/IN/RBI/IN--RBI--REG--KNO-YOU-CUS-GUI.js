    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                const issueDateText = document.querySelector("font > div[align='RIGHT']").textContent;
                ...
                Array.prototype.forEach.call(document.querySelectorAll(".tablebg tr:first-of-type td")[0], function (node) { node.remove(); });
