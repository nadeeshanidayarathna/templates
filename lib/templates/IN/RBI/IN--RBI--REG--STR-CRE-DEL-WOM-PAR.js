    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                wrapElementDate(document, "issue-date", "2000-12-12" + "T00:00:00");
                // ################
                // # content:info #
                // ################
                ...
                const level2And3Elements = document.querySelectorAll("b>p,p>b");
                wrapElement(document, level2And3Elements[1], "level2");
                ...
                for (const contentChild of level2And3Elements) {
                    if (regex = contentChild.textContent.match(regex1) || contentChild.textContent.match(regex2) || contentChild.textContent.match(regex3)) {
                        level3Text = regex[1];
