    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                const level2Element = document.querySelector("p.head[align='RIGHT']");
                wrapElement(document, level2Element, "level2");

                const level3Element = document.querySelectorAll("p[align='CENTER']")[1];
                wrapElement(document, level3Element, "level3");

                const level4Elements = document.querySelectorAll(".head");
