    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                const level2Elements = document.querySelectorAll("font>b, font");
                const regex = /(^\d\.\s)/i;
                ...
                Array.prototype.forEach.call(document.querySelector(".tablebg tr:first-of-type td"), function (node) { node.remove(); });
