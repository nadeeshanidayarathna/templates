    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                wrapElementDate(document, "issue-date", "2011-05-02" + "T00:00:00");
                // ################e
                // # content:info #
                // ################
                ...
                for (const contentChild of level2Elements) {
                    ...
                    if (contentChild.textContent.match(regexL2)) {
                        ...
                        if (islevel3) {
                            contentChild.outerHTML = contentChild.outerHTML.replace(level2Text, "<div title=\"level3\" class=\"level3\">" + level2Text + "</div>");
                        } else {
