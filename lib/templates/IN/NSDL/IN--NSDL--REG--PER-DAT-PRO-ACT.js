    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                wrapElementDate(document, "issue-date", "2012-09-26" + "T00:00:00");
                wrapElementDate(document, "effective-date", "2011-11-24" + "T00:00:00");
                // ################
                // # content:info #
                // ################
                ...
                const level3Element = document.querySelectorAll(".t-11-9-sred,.t-10-9-sred");
                wrapElements(document, level3Element, "level3");


                var level4Element = Array.from(document.querySelectorAll(".clanak,.clanak-"));
