    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                // # root:info #
                // #############
                const level1Element = document.querySelectorAll('.WordSection1 > h1')[1];
                ...
                const level2Element = document.querySelectorAll('.WordSection1 > h2');
                wrapElements(document, level2Element, "level2");

                const level3Element = document.querySelectorAll('.MsoNormal > b'); 
                for (const elements of level3Element) {
                    if (elements.textContent.trim().match(/^\d\.|^\d{2}\./)) {
