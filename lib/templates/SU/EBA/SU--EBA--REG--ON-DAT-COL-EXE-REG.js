    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                wrapElementDate(document, "issue-date", "2022-06-30T00:00:00");
                ...
                const level2Element = document.querySelectorAll(".class2");
                wrapElements(document, level2Element, "level2");

                const level3Element = document.querySelectorAll(".class3");
