    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                wrapElementDate(document, "issue-date", "2015-06-23" + "T00:00:00");
                ...
                const level3Element = document.querySelectorAll('h2, p > b');
                for (const elements of level3Element) {
                    if (elements.tagName == 'H2' || elements.textContent.trim().match(/^2\.\d+\./)) {
                        wrapElement(document, elements, "level3");
                    } else if (elements.textContent.trim().match(/^Q\d+\:?/)) {
