    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                wrapElementDate(document, "issue-date", "2017-12-05" + "T00:00:00");
                wrapElementDate(document, "effective-date", "2017-12-07" + "T00:00:00");
                ...
                const level3Element = document.querySelectorAll('#textTabContent .ti-art');
