    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                // # root:info #
                // #############
                var level1Elements = Array.from(document.querySelectorAll(".title-doc-first")).slice(0, 2);
                level1Text = level1Elements[0].textContent + " " + level1Elements[1].textContent;
                wrapElementLevel1(document, level1Text);
                Array.prototype.forEach.call(level1Elements, function (node) { node.remove(); });
                wrapElementDate(document, "issue-date", "2017-05-17" + "T00:00:00");
                // ################
                // # content:info #
                // ################
