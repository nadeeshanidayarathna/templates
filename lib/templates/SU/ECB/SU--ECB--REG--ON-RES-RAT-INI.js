    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                const level1Element = document.querySelector('.WordSection1 h1');
                wrapElement(document, level1Element, "level1");
                wrapElementDate(document, "issue-date", "2022-09-12" + "T00:00:00");
                ...
                const footnotes = document.querySelectorAll('div[id*="ftn"]');
