    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                wrapElementDate(document, "issue-date", "2022-02-28" + "T00:00:00");
                wrapElementDate(document, "effective-date", "2022-02-28" + "T00:00:00");
                ...
                const level2Element = document.querySelectorAll('.name-article');
