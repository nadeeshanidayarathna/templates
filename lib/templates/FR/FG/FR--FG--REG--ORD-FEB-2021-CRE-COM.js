    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                wrapElementDate(document, "issue-date", "2022-07-31" + "T00:00:00");
                ...
                Array.prototype.forEach.call(document.querySelectorAll(".links-init-version, .small-search-block, .loda, .tabs-secondary.tabs-main, .see-abrogated"), function (node) { node.remove(); });
