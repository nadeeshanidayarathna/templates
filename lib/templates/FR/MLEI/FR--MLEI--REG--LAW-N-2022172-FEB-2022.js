    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                const level3Element = document.querySelectorAll('h2, #LEGISCTA000045168391-1, #LEGISCTA000045168393-3');
                wrapElements(document, level3Element, "level3");

                const level4Elements = document.querySelectorAll('h3');
                for (const level4Element of level4Elements) {
                    if (level4Element.textContent.trim().startsWith('S')) {
                        wrapElement(document, level4Element, 'level4');
                    }
                }
                const level5Element = document.querySelectorAll('.name-article');
