    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                // # root:info #
                // #############
                const level1Element = document.querySelector('h1.main-title');
                wrapElement(document, level1Element, "level1");
                wrapElementDate(document, "issue-date", "2021-10-03" + "T00:00:00");
                ...
                const level2Element = document.querySelectorAll('article.js-child .name-article, h3');
                wrapElements(document, level2Element, "level2");

                const level3Elements = document.querySelector('article.summary-preface .content > p');
                wrapElement(document, level3Elements.childNodes[1], 'level3');
