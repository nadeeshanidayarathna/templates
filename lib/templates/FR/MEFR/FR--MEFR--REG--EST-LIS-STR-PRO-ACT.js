    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                wrapElementDate(document, "issue-date", "2021-07-23" + "T00:00:00");
                ...
                const level2Element = document.querySelectorAll('h3, article.js-child .name-article');
                wrapElements(document, level2Element, "level2");

                const level3Elements = document.querySelectorAll('article.summary-preface .content > p');
                wrapElement(document, level3Elements[0], 'level3');
