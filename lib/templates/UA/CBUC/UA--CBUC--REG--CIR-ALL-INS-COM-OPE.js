    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                // TODO:
                const rootTitle = document.querySelectorAll(".c15")[1];
                wrapElement(document, rootTitle, "level1");
                wrapElementDate(document, "issue-date", "2022-01-06" + "T00:00:00");
                ...
                const contentL2 = document.querySelectorAll(".c15")[1];
