...
const scraper = async function download(url, sp, path) {
    try {
        ...
        });
        {
            ...
            const level2Elements = document.querySelectorAll('ol>li>h2');
               wrapElements(document, level2Elements, 'level2');

               const level3Elements = document.querySelectorAll('ol>li>h3');
               wrapElements(document, level3Elements, 'level3');

               const level4Elements = document.querySelectorAll('ol>li>h4');
               wrapElements(document, level4Elements, 'level4');

               const level5Elements = document.querySelectorAll('ol>li>h5');
