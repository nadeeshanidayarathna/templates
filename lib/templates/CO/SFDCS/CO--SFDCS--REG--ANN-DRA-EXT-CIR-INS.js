        ...
        });
        {
            ...
            await page.evaluate(function process() {
              ...
              //  wrapElementDate(document, "effective-date", "2015-04-29" + "T00:00:00");
               ...
               const level2Elements = document.querySelectorAll('ol>h2');
               wrapElements(document, level2Elements, 'level2');

               const level3Elements = document.querySelectorAll('ol>h3');
               wrapElements(document, level3Elements, 'level3');

               const level4Elements = document.querySelectorAll('ol>h4');
