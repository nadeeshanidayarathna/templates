    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                wrapElementDate(document, "issue-date", "2022-08-09" + "T00:00:00");
              //  wrapElementDate(document, "effective-date", "2015-04-29" + "T00:00:00");
               ...
               // Array.prototype.forEach.call(document.querySelectorAll("#MainContent_pnlHtmlControls > div > .WordSection2"), function (node) { node.remove(); });
                ...
                const level3Elements = document.querySelectorAll('ol>li>h3');
                wrapElements(document, level3Elements, 'level3');

                 const level42Elements = document.querySelectorAll('h4');
                wrapElements(document, level42Elements, 'level4');
  
                const level4Elements = document.querySelectorAll('ol>li>h4>span');
