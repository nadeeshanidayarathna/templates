    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                // TODO:
                const level1Element = document.querySelectorAll(".root")[0];
                wrapElement(document, level1Element, "level1");
                wrapElementDate(document, "issue-date", "2022-02-08" + "T00:00:00");
                ...
                wrapElement(document, content, "ease-content");
                 ...
                 wrapElements(document, level2Elements, "level4");
