                ...
                for(const elementContent of elementContents){
                    if(elementContent.tagName == "P"){
                        if(elementContent.tagName == "P" && elementContent.style.cssText == "text-align: center;" && elementContent.innerText.includes("CODIGO")){
                            ...
                            try { tags.push("<div class='level4' title='level4'>" + elementContent.outerHTML + "</div>"); nextLevel = 5; } catch (e) { }
                        ...
                        if(elementContent.innerText.includes("SECCION")){                            
                            nextLevel = 6;
                        }
                            for(const child of elementContent.childNodes){
                                ...
                                if(child.tagName == "P" && child.style.cssText == "text-align: center;" && child.innerText.includes("LIBRO")){
                                    ...
                                    try { tags.push("<div class='level4' title='level4'>" + child.outerHTML + "</div>"); nextLevel = 5; } catch (e) { }
                                } else if(child.tagName == "P" && child.style.cssText == "text-align: center;" && child.firstChild.nodeName != "STRONG" && child.firstChild.textContent.includes("SECCION")){
                                    try { tags.push("<div class='level5' title='level5'>" + child.outerHTML + "</div>"); nextLevel = 6; } catch (e) { }
                                } else if(child.className == "Section1" && (child.innerText.includes("Artículo 218") || child.innerText.includes("Artículo 497"))){
                                    fullText = child.textContent;
                                    check = (fullText.indexOf("-") + 1)
                                    part1 = fullText.substring(0, check);
                                    part2 = fullText.substring(check, fullText.length);
                                    
                                    try { tags.push("<div class='level" + nextLevel + "' title='level" + nextLevel + "'>" + part1 + "</div>"); } catch (e) { }
                                    ...
                                    for(const divChild of child.childNodes){
                                        if(divChild.tagName == "P" && divChild.align == "center" && divChild.innerText.includes("LIBRO")){
                                            ...
                                            try { tags.push("<div class='level4' title='level4'>" + divChild.outerHTML + "</div>"); nextLevel = 5; } catch (e) { }
                                        } else if(divChild.tagName == "P" && divChild.align == "center" && divChild.innerText.includes("SECCION")){
                                            try { tags.push("<div class='level5' title='level5'>" + divChild.outerHTML + "</div>"); nextLevel = 6;} catch (e) { }
                                        } else if(divChild.tagName == "P" && divChild.align == "center" && divChild.innerText.startsWith("DISPOSICIONES")){
                                            try { tags.push("<div class='level5' title='level5'>" + divChild.outerHTML + "</div>"); nextLevel = 6;} catch (e) { }
                                        } else if(divChild.tagName == "P" && (divChild.align != "center" || divChild.align == "justify") && (divChild.textContent.startsWith("ARTÍCULO") || divChild.textContent.startsWith("Artículo") || divChild.textContent.startsWith("Transitorio"))){
                                        ...
                                        } else if(divChild.tagName == "DIV" && divChild.textContent.includes("Artículo 560")){
                                            fullText = divChild.textContent;
                                ...
                                } else if(child.className == "MsoNormal" && child.textContent.includes("Artículo")) {
                                    try { tags.push("<div class='level" + nextLevel + "' title='level" + nextLevel + "'>" + child.textContent + "</div>"); } catch (e) { }

                                } else if(child.tagName == "P" && (child.style.cssText == "text-align: justify;" || child.style.cssText == "") && child.firstChild.nodeName != "STRONG" && (child.textContent.startsWith("ARTÍCULO") || child.textContent.startsWith("Artículo") || child.textContent.includes("ARTÍCULO") || child.firstChild.localName == "b" || child.textContent.includes("ARTÍCULO 323") || child.textContent.includes("Artículo 149") || child.textContent.startsWith("Transitorio"))){
