    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                wrapElementDate(document, "issue-date", "2022-10-07" + "T00:00:00");
                wrapElementDate(document, "effective-date", "2022-10-10" + "T00:00:00");
                // ################
                // # content:info #
                // ################
                ...
                const footnoteElement = document.querySelectorAll('.cc20');
