    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                const rootTitle = "Prevention of Bribery Act";
                wrapElementLevel1(document, rootTitle);
                wrapElementDate(document, "issue-date", "1976-08-13T00:00:00");
                wrapElementDate(document, "effective-date", "1976-09-02T00:00:00");
