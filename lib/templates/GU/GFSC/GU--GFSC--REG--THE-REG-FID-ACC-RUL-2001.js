    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                wrapElementDate(document, "issue-date", "2001-03-20" + "T00:00:00");
                ...
                const level4Element = document.querySelectorAll('h3, .h3');
                ...
                const footnoteElement = document.querySelectorAll("p[id^='_ftn']");
