    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                wrapElementDate(document, "issue-date", "2017-06-30" + "T00:00:00");
                wrapElementDate(document, "effective-date", "2017-06-30" + "T00:00:00");
                ...
                const level5Element = document.querySelectorAll('.WordSection1 > p');
                for (const elements of level5Element) {
                    if (elements.textContent.trim().match(/^\d+\.\d+\.\d+\.\d+/)) {
                ...
                Array.prototype.forEach.call(document.querySelectorAll("a"), function (node) { if (node.textContent.trim() == "") {node.remove();} });
