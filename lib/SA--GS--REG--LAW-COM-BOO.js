...
const scraper = async function download(url, sp, path) {
    try {
...

        {
            ...
            // 2.Identify
            // 3.Collect
            await page.waitForSelector(".system_terms_textbox");
            ...
            var tags = await page.evaluate(function process(url) {
                ...
                // TODO:
                const elements = document.querySelectorAll("#ddd2")[0];
                try { tags.push("<div class='level1' title='level1'>" + elements.childNodes[12].textContent + "</div>"); } catch (e) { }
                try { tags.push("<div class='level1' title='level1'>" + ); } catch (e) { }
