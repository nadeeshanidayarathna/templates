    ...
    try {
...

        {
            ...
            var tags = await page.evaluate(function process(url) {
                ...
                try { tags.push("<div class='issue-date' title='issue-date'>" + "1989-08-11" + "T00:00:00</div>"); } catch (e) { }
                try { tags.push("<div class='effective-date' title='effective-date'>" + "1989-08-11" + "T00:00:00 </div>"); } catch (e) { }
