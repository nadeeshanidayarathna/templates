    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                const level2Elements = document.querySelectorAll(".c16")[0];
                wrapElement(document, level2Elements, "level2");

                const level2Element = document.querySelectorAll(".c16")[1];
                wrapElement(document, level2Element, "level2");


                const level3Elements = document.querySelectorAll(".c16")[2];
