        ...
        // 3.Collect
        {
            ...
            var tags = await page.evaluate(function process() {
                ...
                // content between root and main iteration
                {
                    ...
                    try { tags.push("<div class='h2'>" + pTransforms[0].textContent + "</div>"); } catch (e) { }
                    try { tags.push("<p>" + pTransforms[1].textContent + "</p>"); } catch (e) { }
                }
                            ...
                            if (innerElement.tagName == "P") {
                                ...
                                if (innerElement.firstChild.tagName == "STRONG") {
                                    ...
                                    if (innerElement.textContent != "") {
                                        ...
                                        try { tags.push("<span class='h3'>" + h3Text + "</span>"); } catch (e) { }
                                        try { tags.push("<span>" + pText + "</span>"); } catch (e) { }
                                        try { tags.push("</div>"); } catch (e) { }
                                    } else {
                                        // heading only h3s
                                        try { tags.push("<div>"); } catch (e) { }
                                        try { tags.push("<span class='h3'>" + h3Text.substring(0, 4) + "</span>"); } catch (e) { }
                                        try { tags.push("<span>" + h3Text.substring(4, h3Text.length) + "</span>"); } catch (e) { }
                                        try { tags.push("</div>"); } catch (e) { }
                                    }
                                } else {
