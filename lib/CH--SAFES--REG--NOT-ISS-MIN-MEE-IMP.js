    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                wrapElementDate(document, "issue-date", "1994-12-14" + "T00:00:00");
                ...
                for (const level2Element of level2Elements) {
                    if (level2Element.textContent.trim().startsWith('附件：') && !(level2Element.textContent.trim().startsWith('附件：关'))) {
