    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                // # root:info #
                // #############
                const rootTitle = "Filing of Actuarial Opinion Summary (“AOS”)";
                ...
                for (const date of dates) {
                    if (date.textContent.trimStart().match(regex)) { // customized match to handle non-standard date
                        const issueDate = new Date(date.textContent.trimStart()); // customized match to handle non-standard date
