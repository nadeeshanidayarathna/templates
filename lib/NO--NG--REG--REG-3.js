    ...
    try {
        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                const level1Element = document.querySelectorAll('.metaTitleText h1')[0];
                wrapElement(document, level1Element, "level1");
                wrapElementDate(document, "issue-date", "2016-11-24" + "T00:00:00");
                wrapElementDate(document, "effective-date", "2017-01-01" + "T00:00:00");

                // ################
                // # content:info #
                // ################

                const contentElement = document.querySelectorAll('#lovdataDocument')[0];
                ...
                for (const level3Element of level3Elements) {
                    if (level3Element.textContent.trim().startsWith('§')) {
                ...
                const elements = document.querySelectorAll('h4,h5');
