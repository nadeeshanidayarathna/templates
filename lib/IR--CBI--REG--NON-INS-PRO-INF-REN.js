        ...
        });
        {
            ...
            await page.evaluate(function process() {
                ...
                for (const DateElement of DateElements) {
                    if (DateElement.textContent.trim().startsWith("22")) {
                        let fullText = DateElement.textContent.trim();

                        let date = fullText.substring(0, 2);
                        let month = fullText.substring(12, 20);
                        let year = fullText.substring(26, 30);
