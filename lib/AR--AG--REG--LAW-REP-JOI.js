    ...
    try {
...

        {
            ...
            var tags = await page.evaluate(function process(url) {
                ...
                Array.prototype.forEach.call(document.querySelectorAll("a"), function (node) { node.remove(); });
        ...
        await test.runTest(browser, originalHtmlPath, originalTextPath, buildHtmlPath, buildTextPath, ".content", ["table", "blockqoute", ".blue_mid_b","li"], "body", []);
        await browser.close();
    } catch (e) {
        console.log(e);
