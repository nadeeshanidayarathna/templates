                ...
                function AddTransform(node) {
                    if (node != undefined) {
                        if (node.nodeType != Node.TEXT_NODE) {
                            const missingImage = node.querySelectorAll("img[src='https://www.handbook.fca.org.uk/publication/techstandards/graphic/CRD_2016_2070_Annex_IV_inline_1_formula.png']");
                            if (missingImage.length == 1) {
                                missingImage[0].remove();
                            }
                        }
