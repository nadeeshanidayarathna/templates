            ...
            var tags = await page.evaluate(function process(url) {
                ...
                try { tags.push("<div class='content'>"); } catch (e) { }
                {
                    ...
                    for (mainBottomElement of mainBottomElements) {
                        ...
                        try { tags.push("<div class='level4' title='level4'>" + tableHeading.outerHTML + "</div>"); tableHeading.remove(); } catch (e) { }
                        ...
                        for (divisie of divisies) {
                            ...
                            try { tags.push("<div class='level5' title='level5'>" + divisieHeading.outerHTML + "</div>"); divisieHeading.remove(); } catch (e) { }
